...
<head>
    <title>Code coverage report for ContextMenu/ContextMenu.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ContextMenu</a> ContextMenu.tsx</h1>
        <div class='clearfix'>
...
const ContextMenuTarget = <span class="fstat-no" title="function not covered" >(_</span>props: IContextMenuTargetProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
const ContextMenuFlyOut = <span class="fstat-no" title="function not covered" >(_</span>props: IContextMenuFlyOutProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
<span class="branch-1 cbranch-no" title="branch not covered" >				sharesAncestor(eventTarget, targetRef.current, 'LABEL');</span>
&nbsp;
	...
	getFlyoutPosition = (): FlyoutPosition | {} | undefined =&gt; {
		const {
			props: {
				direction,
				alignment,
				directonOffset = <span class="branch-0 cbranch-no" title="branch not covered" >ContextMenu.defaultProps.directonOffset,</span>
				getAlignmentOffset = <span class="branch-0 cbranch-no" title="branch not covered" >ContextMenu.defaultProps.getAlignmentOffset,</span>
			},
			state: {
				flyOutHeight,
				flyOutWidth,
...
&nbsp;
	UNSAFE_componentWillReceiveProps(): void {
		_.defer(<span class="fstat-no" title="function not covered" >()</span>: void =&gt; <span class="cstat-no" title="statement not covered" >this.alignFlyOut())</span>;
	}
&nbsp;
