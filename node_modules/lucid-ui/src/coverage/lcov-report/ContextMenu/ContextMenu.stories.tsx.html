...
<head>
    <title>Code coverage report for ContextMenu/ContextMenu.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ContextMenu</a> ContextMenu.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleFileMenuToggle = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >		setIsFileExpanded(!isFileExpanded);</span>
	};
&nbsp;
	const handleEditMenuToggle = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >		setIsEditExpanded(!isEditExpanded);</span>
	};
&nbsp;
	return (
		&lt;section&gt;
			...
			&gt;
				&lt;ContextMenu.Target&gt;
					&lt;div
						style={{
							background: isFileExpanded ? <span class="branch-0 cbranch-no" title="branch not covered" >'#fafafa' </span>: '#eaeaea',
...
&nbsp;
			...
			&gt;
				&lt;ContextMenu.Target&gt;
					&lt;div
						style={{
							background: isEditExpanded ? <span class="branch-0 cbranch-no" title="branch not covered" >'#fafafa' </span>: '#eaeaea',
							outline: 'solid 1px #d1d1d1',
							padding: '4px',
							cursor: 'pointer',
						}}
...
&nbsp;
	return (
		&lt;section&gt;
			...
			&gt;
				&lt;SingleSelect
					onSelect={<span class="fstat-no" title="function not covered" >(i</span>) =&gt; <span class="cstat-no" title="statement not covered" >setDirection(directions[i as any] as any)}</span>
				&gt;
				...
				&lt;TextField
					...
					onChange={<span class="fstat-no" title="function not covered" >(d</span>irectonOffset) =&gt; <span class="cstat-no" title="statement not covered" >setDirectionOffset(directonOffset)}</span>
				/&gt;
				&lt;SingleSelect
					onSelect={<span class="fstat-no" title="function not covered" >(i</span>) =&gt; <span class="cstat-no" title="statement not covered" >setAlignment(alignments[i as any] as any)}</span>
				&gt;
					&lt;SingleSelect.Placeholder&gt;
						Select an alignment
					&lt;/SingleSelect.Placeholder&gt;
				...
				&lt;TextField
					...
					onChange={<span class="fstat-no" title="function not covered" >(a</span>lignmentOffset) =&gt; <span class="cstat-no" title="statement not covered" >setAlignmentOffset(alignmentOffset)}</span>
				/&gt;
				getAlignmentOffset:
				&lt;TextField
...
&nbsp;
			...
			&gt;
				&lt;ContextMenu
					...
					directonOffset={
						_.isEmpty(directonOffset) ? <span class="branch-0 cbranch-no" title="branch not covered" >0 </span>: _.parseInt(directonOffset)
					}
					alignment={(alignment as any) || <span class="branch-1 cbranch-no" title="branch not covered" >undefined}</span>
					alignmentOffset={
						_.isEmpty(alignmentOffset) ? <span class="branch-0 cbranch-no" title="branch not covered" >undefined </span>: _.parseInt(alignmentOffset)
					}
...
&nbsp;
					&lt;ContextMenu.FlyOut style={{ width: 210, ...style }}&gt;
						&lt;div&gt;{`direction: ${direction || <span class="branch-1 cbranch-no" title="branch not covered" >'default'}</span>`}&lt;/div&gt;
						&lt;div&gt;{`directonOffset: ${directonOffset || <span class="branch-1 cbranch-no" title="branch not covered" >'default'}</span>`}&lt;/div&gt;
						&lt;div&gt;{`alignment: ${alignment || <span class="branch-1 cbranch-no" title="branch not covered" >'default'}</span>`}&lt;/div&gt;
						&lt;div&gt;{`alignmentOffset: ${alignmentOffset || <span class="branch-1 cbranch-no" title="branch not covered" >'default'}</span>`}&lt;/div&gt;
