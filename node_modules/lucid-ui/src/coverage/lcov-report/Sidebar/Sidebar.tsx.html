...
<head>
    <title>Code coverage report for Sidebar/Sidebar.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Sidebar</a> Sidebar.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
const Primary = <span class="fstat-no" title="function not covered" >(_</span>props: ISidebarPrimaryProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
Primary.peek = {
...
&nbsp;
const Title = <span class="fstat-no" title="function not covered" >(_</span>props: ISidebarTitleProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
Title.peek = {
...
&nbsp;
const Bar = <span class="fstat-no" title="function not covered" >(_</span>props: ISidebarBarProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
Bar.peek = {
			...
			&lt;SplitVertical
				...
				style={{
					minWidth: isExpanded
						? _.isNumber(width)
							? width + 6
							: <span class="branch-1 cbranch-no" title="branch not covered" >`calc(${width} + 6px)`</span>
						: undefined,
					...style,
				}}
				className={cx(
