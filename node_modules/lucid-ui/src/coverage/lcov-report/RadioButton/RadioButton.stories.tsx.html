...
<head>
    <title>Code coverage report for RadioButton/RadioButton.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">RadioButton</a> RadioButton.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleSelected = <span class="fstat-no" title="function not covered" >(v</span>alue) =&gt; {
<span class="cstat-no" title="statement not covered" >		setSelected(!value);</span>
	};
&nbsp;
	return (
		&lt;ul&gt;
			&lt;li style={style}&gt;
				...
				&lt;RadioButton
					...
					onSelect={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >handleSelected(selected)}</span>
					tabIndex={20}
				/&gt;
			&lt;/li&gt;
		&lt;/ul&gt;
