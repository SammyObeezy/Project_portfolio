...
<head>
    <title>Code coverage report for DateSelect/DateSelect.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">DateSelect</a> DateSelect.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleSelectDate(date: any) {
...
&nbsp;
			return (
				&lt;section style={{ maxWidth: 400 }}&gt;
					...
					/&gt;
					selected date:{' '}
					{selectedDate &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >selectedDate.toLocaleDateString('en-US')}</span>
				&lt;/section&gt;
			);
		},
	});
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleReset() {
<span class="cstat-no" title="statement not covered" >			this.setState({</span>
				selectMode: 'from',
				from: null,
				to: null,
