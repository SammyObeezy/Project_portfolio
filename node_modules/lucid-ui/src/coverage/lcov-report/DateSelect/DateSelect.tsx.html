...
<head>
    <title>Code coverage report for DateSelect/DateSelect.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">DateSelect</a> DateSelect.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
const DateSelectCalendarMonth = <span class="fstat-no" title="function not covered" >(_</span>props: IDateSelectCalendarMonthProps): null =&gt;
...
&nbsp;
		<span class="missing-if-branch" title="if path not taken" >I</span>if (isFontSizeRelative &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.rootRef)</span> {
			const rootElement = <span class="cstat-no" title="statement not covered" >this.rootRef;</span>
			const { width, height } = <span class="cstat-no" title="statement not covered" >rootElement.getBoundingClientRect();</span>
			const navButtonsWidth = <span class="cstat-no" title="statement not covered" >NAV_BUTTON_SIZE * 2;</span>
			const oneMonthShownWidth =
<span class="cstat-no" title="statement not covered" >				(width - navButtonsWidth) / monthsShown + navButtonsWidth;</span>
			const size = <span class="cstat-no" title="statement not covered" >Math.sqrt(oneMonthShownWidth * height);</span>
			const relativeFontSize = <span class="cstat-no" title="statement not covered" >Math.round(size / 24);</span>
			const relativeMinWidth =
<span class="cstat-no" title="statement not covered" >				((((width - navButtonsWidth) / monthsShown) * 10.1075) /</span>
					relativeFontSize) *
					monthsShown +
				navButtonsWidth;
&nbsp;
<span class="cstat-no" title="statement not covered" >			rootElement.style.fontSize = `${relativeFontSize}px`;</span>
<span class="cstat-no" title="statement not covered" >			rootElement.style.minWidth = `${relativeMinWidth}px`;</span>
		}
	};
&nbsp;
	renderCalendarMonth = (
		...
		return (
			&lt;CalendarMonth
				...
				cursor={cursor}
				from={isRangeSameDay ? <span class="branch-0 cbranch-no" title="branch not covered" >null </span>: from}
				to={isRangeSameDay ? <span class="branch-0 cbranch-no" title="branch not covered" >null </span>: to}
				selectedDays={isRangeSameDay ? <span class="branch-0 cbranch-no" title="branch not covered" >from </span>: selectedDays}
				disabledDays={disabledDays}
				selectMode={selectMode}
				onDayClick={onDayClick}
				onDayMouseEnter={showCursorHighlight ? onDayMouseEnter : <span class="branch-1 cbranch-no" title="branch not covered" >_.noop}</span>
				onDayMouseLeave={showCursorHighlight ? onDayMouseLeave : <span class="branch-1 cbranch-no" title="branch not covered" >_.noop}</span>
