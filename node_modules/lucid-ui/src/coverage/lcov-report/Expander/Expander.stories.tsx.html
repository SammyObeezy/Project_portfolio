...
<head>
    <title>Code coverage report for Expander/Expander.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Expander</a> Expander.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleExpanded = <span class="fstat-no" title="function not covered" >(i</span>sExpanded: any) =&gt; {
...
&nbsp;
	return (
		&lt;Expander isExpanded={isExpanded} onToggle={handleExpanded}&gt;
			&lt;Expander.Label&gt;{isExpanded ? <span class="branch-0 cbranch-no" title="branch not covered" >'Show Less' </span>: 'Show More'}&lt;/Expander.Label&gt;
			&lt;p&gt;
