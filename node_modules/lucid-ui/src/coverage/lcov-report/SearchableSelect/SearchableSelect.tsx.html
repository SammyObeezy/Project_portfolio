...
<head>
    <title>Code coverage report for SearchableSelect/SearchableSelect.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SearchableSelect</a> SearchableSelect.tsx</h1>
        <div class='clearfix'>
...
<a name='L637'></a><a href='#L637'>637</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
const Placeholder = <span class="fstat-no" title="function not covered" >(_</span>props: ISearchableSelectPlaceholderProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
const Option = <span class="fstat-no" title="function not covered" >(_</span>props: ISearchableSelectOptionProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
&nbsp;
...
&nbsp;
	UNSAFE_componentWillReceiveProps = <span class="fstat-no" title="function not covered" >(n</span>extProps: ISearchableSelectProps) =&gt; {
		...
		const {
			...
			ungroupedOptionData,
			optionGroupDataLookup,
		} = <span class="cstat-no" title="statement not covered" >DropMenu.preprocessOptionData(nextProps, SearchableSelect);</span>
&nbsp;
...
&nbsp;
	setSearchField = (e: SearchField) =&gt; {
		<span class="missing-if-branch" title="if path not taken" >I</span>if (e &amp;&amp; this.state.isFocusOnSearchFieldRequired) {
<span class="cstat-no" title="statement not covered" >			this.setState({ isFocusOnSearchFieldRequired: false });</span>
...
<span class="cstat-no" title="statement not covered" >				e.focus({ preventScroll: true });</span>
			}, 0);
		}
	};
&nbsp;
	renderUnderlinedChildren = <span class="fstat-no" title="function not covered" >(c</span>hildText: string, searchText: string) =&gt; {
		const [pre, match, post] = <span class="cstat-no" title="statement not covered" >partitionText(</span>
			childText,
			...
			return (
				...
				&gt;
					{_.isString(optionProps.children)
						? <span class="branch-0 cbranch-no" title="branch not covered" >this.renderUnderlinedChildren(optionProps.children, searchText)</span>
						: _.isFunction(optionProps.children)
						? React.createElement(optionProps.children, { searchText })
						: <span class="branch-1 cbranch-no" title="branch not covered" >optionProps.children}</span>
				&lt;/DropMenu.Option&gt;
			);
		}
&nbsp;
							...
							&gt;
								{_.isNumber(selectedIndex)
									? _.get(
									  ...
									  ((Children) =&gt;
											_.isFunction(Children) ? <span class="branch-0 cbranch-no" title="branch not covered" >&lt;Children /&gt; </span>: Children)(
