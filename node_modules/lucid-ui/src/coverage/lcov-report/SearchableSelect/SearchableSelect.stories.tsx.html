...
<head>
    <title>Code coverage report for SearchableSelect/SearchableSelect.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SearchableSelect</a> SearchableSelect.stories.tsx</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { map, isNil, escapeRegExp } from 'lodash';
...
&nbsp;
	return (
		&lt;section style={{ minHeight: 120 }}&gt;
			...
			{!isNil(selectedIndex) &amp;&amp; (
<span class="branch-1 cbranch-no" title="branch not covered" >				&lt;section style={{ paddingTop: 9, paddingLeft: 9 }}&gt;</span>
...
&nbsp;
const optionFilter = <span class="fstat-no" title="function not covered" >(</span>
	searchText: string,
	{ filterText }: { filterText: string }
) =&gt; {
<span class="cstat-no" title="statement not covered" >	if (filterText) {</span>
<span class="cstat-no" title="statement not covered" >		return new RegExp(escapeRegExp(searchText), 'i').test(filterText);</span>
	}
...
<span class="cstat-no" title="statement not covered" >					&lt;OptionCols col1='Red' col2='#FF0000' textMatch={searchText} /&gt;</span>
				)}
			&lt;/Option&gt;
&nbsp;
			&lt;Option filterText='Green' Selected='Green (#00FF00)'&gt;
				{<span class="fstat-no" title="function not covered" >({</span> searchText }: { searchText: string }) =&gt; (
<span class="cstat-no" title="statement not covered" >					&lt;OptionCols col1='Green' col2='#00FF00' textMatch={searchText} /&gt;</span>
				)}
			&lt;/Option&gt;
&nbsp;
			&lt;Option filterText='Blue' Selected='Blue (#0000FF)'&gt;
				{<span class="fstat-no" title="function not covered" >({</span> searchText }: { searchText: string }) =&gt; (
<span class="cstat-no" title="statement not covered" >					&lt;OptionCols col1='Blue' col2='#0000FF' textMatch={searchText} /&gt;</span>
				)}
			&lt;/Option&gt;
		&lt;/OptionGroup&gt;,
	]),
...
&nbsp;
	return (
		&lt;section style={{ minHeight: 120 }}&gt;
			&lt;SearchableSelect
				{...args}
				Error={selectedIndex === 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >null </span>: 'Please choose option California'}
