...
<head>
    <title>Code coverage report for ProgressBar/ProgressBar.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ProgressBar</a> ProgressBar.stories.tsx</h1>
        <div class='clearfix'>
			...
			return (
				&lt;div&gt;
					...
					&lt;TextField
						...
						onSubmit={<span class="fstat-no" title="function not covered" >(v</span>alue) =&gt;
<span class="cstat-no" title="statement not covered" >							this.setState({ percentComplete: value, value: '' })</span>
						}
					/&gt;
