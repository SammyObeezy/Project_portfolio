...
<head>
    <title>Code coverage report for CheckboxLabeled/CheckboxLabeled.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">CheckboxLabeled</a> CheckboxLabeled.stories.tsx</h1>
        <div class='clearfix'>
...
const Template: Story&lt;ICheckboxLabeledProps&gt; = (args) =&gt; {
	...
	return (
		&lt;CheckboxLabeled
			{...args}
			isSelected={selected}
			onSelect={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >setSelected(!selected)}</span>
		/&gt;
	);
};
&nbsp;
