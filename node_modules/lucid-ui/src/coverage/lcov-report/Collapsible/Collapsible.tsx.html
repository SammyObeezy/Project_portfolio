...
<head>
    <title>Code coverage report for Collapsible/Collapsible.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Collapsible</a> Collapsible.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	componentDidMount(): void {
		...
		_.delay(<span class="fstat-no" title="function not covered" >()</span>: void =&gt; {
...
<span class="cstat-no" title="statement not covered" >			this.isAnimated = this.props.isAnimated;</span>
		}, 32);
	}
&nbsp;
<span class="fstat-no" title="function not covered" >	co</span>mponentDidUpdate(): void {
<span class="cstat-no" title="statement not covered" >		this.isAnimated = false;</span>
<span class="cstat-no" title="statement not covered" >		this.delayTimer = _.delay(<span class="fstat-no" title="function not covered" >()</span>: void =&gt; {</span>
<span class="cstat-no" title="statement not covered" >			if (this.props.isExpanded) {</span>
				const maxHeight = <span class="cstat-no" title="statement not covered" >_.get(this, 'rootRef.current.scrollHeight');</span>
<span class="cstat-no" title="statement not covered" >				if (maxHeight !== this.state.maxHeight) {</span>
<span class="cstat-no" title="statement not covered" >					if (this._isMounted) {</span>
<span class="cstat-no" title="statement not covered" >						this.setState({</span>
							maxHeight,
						});
...
&nbsp;
	componentWillUnmount(): void {
		this.delayTimer &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >clearTimeout(this.delayTimer);</span>
	}
&nbsp;
							...
							style: {
								height:
									tween.height !== maxHeight
										? <span class="branch-0 cbranch-no" title="branch not covered" >tween.height &lt; 0</span>
											? 0
											: tween.height
										: null,
								overflow: 'hidden',
								...
								{isMountControlled &amp;&amp; !isExpanded
									? _.isNull(maxHeight) ||
									  Math.abs(tween.height) &gt; (mountControlThreshold as number)
										? <span class="branch-0 cbranch-no" title="branch not covered" >children</span>
										: null
									: children}
							&lt;/div&gt;,
						]
