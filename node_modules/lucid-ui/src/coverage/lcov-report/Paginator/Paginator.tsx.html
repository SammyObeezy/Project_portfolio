...
<head>
    <title>Code coverage report for Paginator/Paginator.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Paginator</a> Paginator.tsx</h1>
        <div class='clearfix'>
...
const Paginator: FC&lt;IPaginatorProps&gt; &amp; ILucidComponent = (
	...
	const {
		...
		objectLabel,
		objectLabelPlural,
		onPageSelect = <span class="branch-0 cbranch-no" title="branch not covered" >defaultProps.onPageSelect,</span>
		onPageSizeSelect,
		pageSizeOptions,
		selectedPageIndex = <span class="branch-0 cbranch-no" title="branch not covered" >defaultProps.selectedPageIndex,</span>
			...
			{showTotalObjects &amp;&amp; _.isNumber(totalCount) &amp;&amp; (
				&lt;div className={cx('&amp;-total-count')}&gt;
					{_.isFunction(showTotalObjects)
						? <span class="branch-0 cbranch-no" title="branch not covered" >showTotalObjects(totalCount)</span>
