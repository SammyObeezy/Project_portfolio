...
<head>
    <title>Code coverage report for ResponsiveGrid/ResponsiveGrid.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ResponsiveGrid</a> ResponsiveGrid.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
/** Cell */
const Cell = <span class="fstat-no" title="function not covered" >(_</span>props: IResponsiveGridCellProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >	sh</span>ouldComponentUpdate(nextProps: IResponsiveGridProps) {
		const { width, breakPoints } = <span class="cstat-no" title="statement not covered" >this.props;</span>
		const { width: nextWidth } = <span class="cstat-no" title="statement not covered" >nextProps;</span>
		const [breakOne, breakTwo] = <span class="cstat-no" title="statement not covered" >breakPoints;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >		if (nextWidth &lt; width) {</span>
<span class="cstat-no" title="statement not covered" >			return (</span>
				(nextWidth &lt; breakOne &amp;&amp; width &gt;= breakOne) ||
				(nextWidth &lt; breakTwo &amp;&amp; width &gt;= breakTwo)
			);
		} else <span class="cstat-no" title="statement not covered" >if (nextWidth &gt; width) {</span>
<span class="cstat-no" title="statement not covered" >			return (</span>
				(nextWidth &gt; breakOne &amp;&amp; width &lt;= breakOne) ||
				(nextWidth &gt; breakTwo &amp;&amp; width &lt;= breakTwo)
			);
