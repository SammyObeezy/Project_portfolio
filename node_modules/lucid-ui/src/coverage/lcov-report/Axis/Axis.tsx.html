...
<head>
    <title>Code coverage report for Axis/Axis.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Axis</a> Axis.tsx</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >				dy = 'null';</span>
		}
		return {
			transform,
			textAnchor,
	...
	const orientationKey = textOrientation || <span class="branch-1 cbranch-no" title="branch not covered" >'horizontal';</span>
&nbsp;
