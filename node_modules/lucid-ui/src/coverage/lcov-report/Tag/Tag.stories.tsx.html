...
<head>
    <title>Code coverage report for Tag/Tag.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Tag</a> Tag.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleRemove = <span class="fstat-no" title="function not covered" >({</span> props: { callbackId } }: any) =&gt; {
		const newRemovedItems = <span class="cstat-no" title="statement not covered" >_.set(removedItems, callbackId, true);</span>
<span class="cstat-no" title="statement not covered" >		setRemovedItems({ ...newRemovedItems });</span>
	};
&nbsp;
	return (
		&lt;div&gt;
			{_.map(groups, ([group, names], groupIndex) =&gt; {
				...
				<span class="missing-if-branch" title="if path not taken" >I</span>if (_.get(removedItems, groupCallbackId) === true) {
...
&nbsp;
							<span class="missing-if-branch" title="if path not taken" >I</span>if (_.get(removedItems, nameCallbackId) === true) {
<span class="cstat-no" title="statement not covered" >								return null;</span>
							}
&nbsp;
							return (
