...
<head>
    <title>Code coverage report for ExampleComponent/ExampleComponent.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ExampleComponent</a> ExampleComponent.tsx</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Required for all new components
...
export const ExampleComponent: FC&lt;IExampleComponentProps&gt; = ({
	...
	const handleX = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >		alert('This is an example of a handler function');</span>
	};
&nbsp;
	return (
		&lt;div
