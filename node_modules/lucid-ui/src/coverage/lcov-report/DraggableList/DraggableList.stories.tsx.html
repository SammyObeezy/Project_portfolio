...
<head>
    <title>Code coverage report for DraggableList/DraggableList.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">DraggableList</a> DraggableList.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleDrop = <span class="fstat-no" title="function not covered" >({</span>
		oldIndex,
		newIndex,
	}: {
		oldIndex: number;
		...
		const updatedItems = <span class="cstat-no" title="statement not covered" >items.filter(</span>
<span class="fstat-no" title="function not covered" >			(c</span>olumn: string, index: number) =&gt; <span class="cstat-no" title="statement not covered" >index !== oldIndex</span>
		);
<span class="cstat-no" title="statement not covered" >		updatedItems.splice(newIndex, 0, items[oldIndex]);</span>
<span class="cstat-no" title="statement not covered" >		console.info(updatedItems);</span>
<span class="cstat-no" title="statement not covered" >		setItems(updatedItems);</span>
	};
&nbsp;
	return (
