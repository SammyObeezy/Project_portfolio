...
<head>
    <title>Code coverage report for DraggableList/DraggableList.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">DraggableList</a> DraggableList.tsx</h1>
        <div class='clearfix'>
...
export interface IDraggableListItemProps
	extends StandardProps,
		...
		&gt; {}
&nbsp;
const DraggableListItem = <span class="fstat-no" title="function not covered" >(_</span>props: IDraggableListItemProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
	const handleDragStart = (index: number) =&gt; {
		return <span class="fstat-no" title="function not covered" >(e</span>vent: React.DragEvent) =&gt; {
			const { dataTransfer } = <span class="cstat-no" title="statement not covered" >event;</span>
<span class="cstat-no" title="statement not covered" >			dataTransfer.effectAllowed = 'move';</span>
<span class="cstat-no" title="statement not covered" >			dataTransfer.dropEffect = 'move';</span>
<span class="cstat-no" title="statement not covered" >			dataTransfer.setData('drag', 'drag');</span>
<span class="cstat-no" title="statement not covered" >			onDragStart(index, { event, props });</span>
		};
	};
&nbsp;
			...
			onDrop(
				{
					...
					newIndex:
						dragIndexes.dragOverIndex &gt; dragIndexes.dragIndex
							...
							: <span class="branch-1 cbranch-no" title="branch not covered" >dragOverIndex,</span>
				},
				{ event, props }
			);
		}
