...
<head>
    <title>Code coverage report for SwitchLabeled/SwitchLabeled.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SwitchLabeled</a> SwitchLabeled.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleSelected = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >		setIsSelected(!isSelected);</span>
	};
&nbsp;
	return (
		&lt;SwitchLabeled
...
&nbsp;
	const handleSelectedAirplaneMode = <span class="fstat-no" title="function not covered" >(i</span>sSelected: any) =&gt; {
...
&nbsp;
	const handleSelectedBluetooth = <span class="fstat-no" title="function not covered" >(i</span>sSelected: any) =&gt; {
<span class="cstat-no" title="statement not covered" >		setState({</span>
			...state,
...
&nbsp;
	const handleSelectedCellularData = <span class="fstat-no" title="function not covered" >(i</span>sSelected: any) =&gt; {
<span class="cstat-no" title="statement not covered" >		setState({</span>
			...state,
...
&nbsp;
	const handleSelectedSpam = <span class="fstat-no" title="function not covered" >(i</span>sSelected: any) =&gt; {
<span class="cstat-no" title="statement not covered" >		setState({</span>
			...state,
			spam: isSelected,
		});
...
&nbsp;
	const spamSwitchLabel = state.spam
		? <span class="branch-0 cbranch-no" title="branch not covered" >'Yes! I would like to receive updates, special offers, and other information from Xandr and its subsidiaries.'</span>
		...
		&lt;section&gt;
			...
			&gt;
				&lt;SwitchLabeled
					...
					isSelected={state.airplaneMode === true}
					Label={`Airplane Mode ${
						state.airplaneMode === true ? <span class="branch-0 cbranch-no" title="branch not covered" >'Activated' </span>: 'Deactivated'
					}`}
					onSelect={handleSelectedAirplaneMode}
					style={style}
				/&gt;
				&lt;SwitchLabeled
					...
					isSelected={state.bluetooth === true}
					Label={`Bluetooth ${
						state.bluetooth === true ? <span class="branch-0 cbranch-no" title="branch not covered" >'Enabled' </span>: 'Disabled'
					}`}
					onSelect={handleSelectedBluetooth}
					style={style}
				/&gt;
				&lt;SwitchLabeled
					{...args}
					isSelected={state.cellularData === true}
					Label={`${state.cellularData ? <span class="branch-0 cbranch-no" title="branch not covered" >'Use' </span>: 'Do Not Use'} Cellular Data`}
					onSelect={handleSelectedCellularData}
					style={style}
				/&gt;
			&lt;/span&gt;
