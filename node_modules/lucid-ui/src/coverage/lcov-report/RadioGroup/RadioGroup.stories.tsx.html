...
<head>
    <title>Code coverage report for RadioGroup/RadioGroup.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">RadioGroup</a> RadioGroup.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleSelect = <span class="fstat-no" title="function not covered" >(i</span>dx) =&gt; {
<span class="cstat-no" title="statement not covered" >		setSelectedIndex(idx);</span>
	};
&nbsp;
	return (
		&lt;div&gt;
...
export const OnSelectOnChild: Story&lt;IRadioGroupProps&gt; = (args) =&gt; {
	const [selectedIndex, setSelectedIndex] = useState(0);
&nbsp;
	const handleSelect = <span class="fstat-no" title="function not covered" >(i</span>ndex) =&gt; {
<span class="cstat-no" title="statement not covered" >		setSelectedIndex(index);</span>
	};
&nbsp;
			...
			{children.map((child, idx) =&gt; {
				return (
					&lt;RadioGroup.RadioButton
						...
						key={idx}
						style={style}
						onSelect={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >handleSelect(idx)}</span>
					&gt;
...
&nbsp;
	const handleSelectedTallSimon = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >		setHeight('Tall Simon');</span>
	};
&nbsp;
	const handleSelectedShortSimon = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >		setHeight('Short Simon');</span>
	};
&nbsp;
	return (
		&lt;RadioGroup {...args}&gt;
