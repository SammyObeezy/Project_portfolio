...
<head>
    <title>Code coverage report for RadioGroup/RadioGroup.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">RadioGroup</a> RadioGroup.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
/** RadioGroup Label */
const RadioGroupLabel = <span class="fstat-no" title="function not covered" >(p</span>rops: IRadioButtonLabeledLabelProps) =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
