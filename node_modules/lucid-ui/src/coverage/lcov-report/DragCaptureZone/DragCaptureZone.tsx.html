...
<head>
    <title>Code coverage report for DragCaptureZone/DragCaptureZone.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">DragCaptureZone</a> DragCaptureZone.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	handleTouchDragStart = <span class="fstat-no" title="function not covered" >(e</span>vent: React.TouchEvent&lt;HTMLDivElement&gt;): void =&gt; {
		const pageX = <span class="cstat-no" title="statement not covered" >event.touches[0].pageX;</span>
		const pageY = <span class="cstat-no" title="statement not covered" >event.touches[0].pageY;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >		event.preventDefault();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >		this.props.onDragStart(</span>
			{
				dX: 0,
				dY: 0,
				pageX,
