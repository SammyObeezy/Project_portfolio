...
<head>
    <title>Code coverage report for LineChart/LineChart.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">LineChart</a> LineChart.tsx</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>66/97</span>
            </div>
...
<a name='L1333'></a><a href='#L1333'>1333</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
	static defaultProps = {
		...
		yAxisTitle: null,
		yAxisTitleColor: '#000',
		yAxisTooltipFormatter: <span class="fstat-no" title="function not covered" >(y</span>Field: string, yValueFormatted: number) =&gt;
...
&nbsp;
	handleToolTipHoverZone = <span class="fstat-no" title="function not covered" >(</span>
		...
		const axisLines = y2AxisFields ? (
			&lt;g transform={`translate(${margin.left as number}, ${margin.top})`}&gt;
				&lt;Lines
					...
					data={data || (<span class="branch-1 cbranch-no" title="branch not covered" >{} as any)</span>}
...
&nbsp;
			...
			y2AxisMax = (y2AxisFields &amp;&amp; y2AxisIsStacked
				? <span class="branch-0 cbranch-no" title="branch not covered" >maxByFieldsStacked(data as any, y2AxisFields)</span>
...
&nbsp;
			const y2AxisFinalFormatter = y2AxisFormatter
				...
				: y2Scale
				? y2Scale.tickFormat()
				: (<span class="branch-1 cbranch-no" title="branch not covered" >_.identity as yFormatterFunction)</span>;
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >					&lt;Legend.Item</span>
						key={index}
						hasPoint={y2AxisHasPointsFinal}
						hasLine={y2AxisHasLinesFinal}
						color={_.get(
				...
				{hasToolTips ? (
					&lt;g transform={`translate(${margin.left}, ${margin.top})`}&gt;
						&lt;rect
							...
							width={innerWidth}
							height={innerHeight}
							onMouseMove={<span class="fstat-no" title="function not covered" >(e</span>vent) =&gt; {
<span class="cstat-no" title="statement not covered" >								this.handleToolTipHoverZone(</span>
									event as unknown as {
										clientX: number;
