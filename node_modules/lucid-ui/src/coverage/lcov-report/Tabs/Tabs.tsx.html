...
<head>
    <title>Code coverage report for Tabs/Tabs.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Tabs</a> Tabs.tsx</h1>
        <div class='clearfix'>
...
const Tab = (props: ITabPropsWithPassThroughs): React.ReactElement =&gt; {
	const {
		...
		index = <span class="branch-0 cbranch-no" title="branch not covered" >0,</span> // this defaults should not be invoked unless someone is using `Tab` outside of `Tabs`
		onSelect = <span class="branch-0 cbranch-no" title="branch not covered" >_.noop,</span> // this defaults should not be invoked unless someone is using `Tab` outside of `Tabs`
		...passThroughs
	} = props;
		...
		return (
			...
			&gt;
				...
				&lt;div className={cx('&amp;-content')}&gt;
					{_.get(tabChildProps, [
						_.isUndefined(actualSelectedIndex) ? <span class="branch-0 cbranch-no" title="branch not covered" >'' </span>: actualSelectedIndex,
						'children',
					])}
				&lt;/div&gt;
			&lt;/div&gt;
