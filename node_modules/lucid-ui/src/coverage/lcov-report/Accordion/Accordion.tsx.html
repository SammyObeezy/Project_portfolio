...
<head>
    <title>Code coverage report for Accordion/Accordion.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Accordion</a> Accordion.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleToggle = (
		...
		const selectedIndex = isExpanded ? index : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
&nbsp;
