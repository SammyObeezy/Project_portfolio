...
<head>
    <title>Code coverage report for SplitHorizontal/SplitHorizontal.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SplitHorizontal</a> SplitHorizontal.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleToggle() {
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleResizing(height: any) {
<span class="cstat-no" title="statement not covered" >			this.setState({ newHeight: height });</span>
		},
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleResize(height: any) {
<span class="cstat-no" title="statement not covered" >			this.setState({ newHeight: height });</span>
		},
&nbsp;
		render() {
