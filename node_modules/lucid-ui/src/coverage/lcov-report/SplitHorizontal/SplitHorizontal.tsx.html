...
<head>
    <title>Code coverage report for SplitHorizontal/SplitHorizontal.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SplitHorizontal</a> SplitHorizontal.tsx</h1>
        <div class='clearfix'>
...
<a name='L639'></a><a href='#L639'>639</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
export const SplitHorizontalTopPane = <span class="fstat-no" title="function not covered" >(</span>
...
export const SplitHorizontalBottomPane = <span class="fstat-no" title="function not covered" >(</span>
...
const SplitHorizontalDivider = <span class="fstat-no" title="function not covered" >(_</span>props: ISplitHorizontalDividerProps): null =&gt;
...
&nbsp;
	secondaryStartRect = this.topPaneRef.current
		? <span class="branch-0 cbranch-no" title="branch not covered" >this.topPaneRef.current.getBoundingClientRect()</span>
		: null;
&nbsp;
	getPanes = (): {
	...
	applyDeltaToSecondaryHeight = (
		...
		if (isExpanded) {
			(secondaryRef.current as HTMLDivElement).style.flexBasis = `${
				secondaryStartRect.height + dY * (secondary === bottom ? <span class="branch-0 cbranch-no" title="branch not covered" >-1 </span>: 1)
			}px`;
