...
<head>
    <title>Code coverage report for ToolTip/ToolTip.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ToolTip</a> ToolTip.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
const ToolTipTarget = <span class="fstat-no" title="function not covered" >(_</span>props: IToolTipTargetProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
const ToolTipTitle = <span class="fstat-no" title="function not covered" >(_</span>props: IToolTipTitleProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
const ToolTipBody = <span class="fstat-no" title="function not covered" >(_</span>props: IToolTipBodyProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
	handleMouseOutFlyout = <span class="fstat-no" title="function not covered" >(e</span>vent: React.MouseEvent) =&gt; {
<span class="cstat-no" title="statement not covered" >		this.setState({ isMouseOverFlyout: false });</span>
<span class="cstat-no" title="statement not covered" >		this.handleMouseOut(event);</span>
	};
&nbsp;
...
&nbsp;
	handleClose = <span class="fstat-no" title="function not covered" >({</span>
		event,
		props,
	}: {
		event: React.MouseEvent;
...
<span class="cstat-no" title="statement not covered" >		this.props.onClose &amp;&amp; this.props.onClose({ event, props: this.props });</span>
	};
&nbsp;
	render() {
		const {
