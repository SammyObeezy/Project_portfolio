...
<head>
    <title>Code coverage report for ToolTip/ToolTip.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ToolTip</a> ToolTip.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
						&lt;div style={{ marginTop: 60, marginBottom: 60 }}&gt;
							&lt;ToolTipDumb
								isCloseable
								onClose={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >this.setState({ isExpanded: false })}</span>
