...
<head>
    <title>Code coverage report for DropMenu/DropMenu.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">DropMenu</a> DropMenu.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleSelect = <span class="fstat-no" title="function not covered" >(o</span>ptionIndex: any) =&gt; {
<span class="cstat-no" title="statement not covered" >		setSelectedIndices(<span class="fstat-no" title="function not covered" >(s</span>electedIndices) =&gt; <span class="cstat-no" title="statement not covered" >[...selectedIndices, optionIndex])</span>;</span>
	};
&nbsp;
	const options = [
		'MS-DOS',
...
&nbsp;
	return (
		&lt;DropMenu {...args} onSelect={<span class="fstat-no" title="function not covered" >(i</span>) =&gt; <span class="cstat-no" title="statement not covered" >handleSelect(i)}</span>&gt;
			&lt;Control&gt;
				{_.isEmpty(selectedIndices)
					? 'Select OS'
					: <span class="branch-1 cbranch-no" title="branch not covered" >options[_.last(selectedIndices) as any]}</span>
			&lt;/Control&gt;
...
&nbsp;
	return (
		&lt;div style={{ textAlign: 'right' }}&gt;
			&lt;DropMenu {...args} onSelect={<span class="fstat-no" title="function not covered" >(i</span>) =&gt; <span class="cstat-no" title="statement not covered" >handleSelect(i)}</span> alignment='center'&gt;
				&lt;Control&gt;
					&lt;Button&gt;
						{_.isEmpty(selectedIndices)
							? 'Click Me'
