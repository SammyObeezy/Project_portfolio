...
<head>
    <title>Code coverage report for DropMenu/DropMenu.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">DropMenu</a> DropMenu.tsx</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">92.26% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>155/168</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>92/110</span>
            </div>
...
<a name='L1139'></a><a href='#L1139'>1139</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
const Header = <span class="fstat-no" title="function not covered" >(_</span>props: IDropMenuHeaderProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
const Control = <span class="fstat-no" title="function not covered" >(_</span>props: IDropMenuControlProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
const OptionGroup = <span class="fstat-no" title="function not covered" >(_</span>props: IDropMenuOptionGroupProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
const Option = <span class="fstat-no" title="function not covered" >(_</span>props: IDropMenuOptionProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
const NullOption = <span class="fstat-no" title="function not covered" >(_</span>props: IDropMenuNullOptionProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
const FixedOption = <span class="fstat-no" title="function not covered" >(_</span>props: IDropMenuFixedOptionProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
const DropMenuContextMenu = <span class="fstat-no" title="function not covered" >(_</span>props: IDropMenuContextMenuProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
		...
		const nullOptions = NullOption
			...
			: <span class="branch-1 cbranch-no" title="branch not covered" >[];</span> // find all NullOption props
&nbsp;
		...
		if (isExpanded) {
			if (event.keyCode === KEYCODE.Enter) {
				...
				const focusedOptionData = _.get(
					flattenedOptionsData,
					_.isNil(focusedIndex) ? <span class="branch-0 cbranch-no" title="branch not covered" >'' </span>: focusedIndex,
					null
				);
				...
				} else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="else path not taken" >E</span>if (_.isNull(focusedIndex)) {</span>
<span class="cstat-no" title="statement not covered" >					onSelect &amp;&amp; onSelect(null, { props: _.first(nullOptions), event });</span>
				}
			}
...
<span class="cstat-no" title="statement not covered" >							onFocusOption &amp;&amp; onFocusOption(null, { props, event });</span>
						}
					}
...
<span class="cstat-no" title="statement not covered" >					event.preventDefault();</span>
<span class="cstat-no" title="statement not covered" >					focusedIndex &amp;&amp;</span>
						onFocusOption &amp;&amp;
						onFocusOption(
							_.findLastIndex(
								flattenedOptionsData,
					...
					onFocusOption &amp;&amp;
						onFocusOption(
							_.findIndex(
								flattenedOptionsData,
								isOptionVisible,
								!_.isNil(focusedIndex) ? <span class="branch-0 cbranch-no" title="branch not covered" >focusedIndex </span>: undefined
							),
							{ props, event }
						);
				}
