...
<head>
    <title>Code coverage report for Selection/Selection.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Selection</a> Selection.stories.tsx</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { set, map, get } from 'lodash';
...
export const Kinds: Story&lt;ISelectionProps&gt; = (args) =&gt; {
	return (
		&lt;Resizer&gt;
			{(width) =&gt; {
				const responsiveMode = width &gt;= 400 ? <span class="branch-0 cbranch-no" title="branch not covered" >'large' </span>: 'small';
&nbsp;
				return (
					&lt;div&gt;
...
&nbsp;
	...
	const handleRemove = <span class="fstat-no" title="function not covered" >({</span> props }) =&gt; {
		const { callbackId } = <span class="cstat-no" title="statement not covered" >props;</span>
<span class="cstat-no" title="statement not covered" >		setRemovedItems({ ...set(removedItems, callbackId, true) });</span>
	};
&nbsp;
	return (
		&lt;Resizer&gt;
				...
				return (
					&lt;div&gt;
						{map(groups, ([group, names], groupIndex) =&gt; {
							...
							<span class="missing-if-branch" title="if path not taken" >I</span>if (get(removedItems, groupCallbackId) === true) {
							...
							return (
								...
								&gt;
									{map(names, (name, nameIndex) =&gt; {
										...
										<span class="missing-if-branch" title="if path not taken" >I</span>if (get(removedItems, nameCallbackId) === true) {
<span class="cstat-no" title="statement not covered" >											return null;</span>
										}
										return (
											&lt;Selection
