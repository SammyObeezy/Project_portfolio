...
<head>
    <title>Code coverage report for StickySection/StickySection.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">StickySection</a> StickySection.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	handleScroll = <span class="fstat-no" title="function not covered" >()</span>: void =&gt; {
		const { lowerBound, topOffset = <span class="branch-0 cbranch-no" title="branch not covered" >0 </span>} = <span class="cstat-no" title="statement not covered" >this.props;</span>
&nbsp;
		const { isAboveFold, containerRect } = <span class="cstat-no" title="statement not covered" >this.state;</span>
&nbsp;
		const nextContainerRect = <span class="cstat-no" title="statement not covered" >this.getContainerRect();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >		if (window.pageYOffset + topOffset &gt;= nextContainerRect.top) {</span>
<span class="cstat-no" title="statement not covered" >			if (!isAboveFold) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >		if (_.isNumber(lowerBound) &amp;&amp; window.pageYOffset &gt;= lowerBound) {</span>
<span class="cstat-no" title="statement not covered" >			this.setState({</span>
				isAboveFold: false,
			});
		}
...
&nbsp;
	getContainerRect = <span class="fstat-no" title="function not covered" >()</span>: IContainerRect =&gt; {
		const containerRect = <span class="cstat-no" title="statement not covered" >getAbsoluteBoundingClientRect(</span>
			this.scrollContainer.current as HTMLElement
		);
		const stickyRect = <span class="cstat-no" title="statement not covered" >(</span>
			this.stickySection.current as HTMLElement
		).getBoundingClientRect();
		const frameRect = <span class="cstat-no" title="statement not covered" >(</span>
...
&nbsp;
	componentDidMount(): void {
		setTimeout(<span class="fstat-no" title="function not covered" >()</span>: void =&gt; {
<span class="cstat-no" title="statement not covered" >			this.setState({</span>
