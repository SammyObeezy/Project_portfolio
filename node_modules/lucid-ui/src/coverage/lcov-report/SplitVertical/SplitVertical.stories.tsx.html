...
<head>
    <title>Code coverage report for SplitVertical/SplitVertical.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SplitVertical</a> SplitVertical.stories.tsx</h1>
        <div class='clearfix'>
...
<a name='L408'></a><a href='#L408'>408</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
	const handleToggle = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >		setIsExpanded(!isExpanded);</span>
	};
&nbsp;
	return (
		&lt;section&gt;
...
&nbsp;
	const handleResizing = <span class="fstat-no" title="function not covered" >(w</span>idth: any) =&gt; {
<span class="cstat-no" title="statement not covered" >		setNewWidth(width);</span>
	};
&nbsp;
	const handleResize = <span class="fstat-no" title="function not covered" >(w</span>idth: any) =&gt; {
<span class="cstat-no" title="statement not covered" >		setNewWidth(width);</span>
	};
&nbsp;
	return (
