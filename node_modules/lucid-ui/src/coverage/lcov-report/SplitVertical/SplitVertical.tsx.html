...
<head>
    <title>Code coverage report for SplitVertical/SplitVertical.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SplitVertical</a> SplitVertical.tsx</h1>
        <div class='clearfix'>
...
<a name='L659'></a><a href='#L659'>659</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
export const SplitVerticalRightPane = <span class="fstat-no" title="function not covered" >(</span>
	_props: ISplitVerticalRightPaneProps
): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
export const SplitVerticalLeftPane = <span class="fstat-no" title="function not covered" >(</span>
...
const SplitVerticalDivider = <span class="fstat-no" title="function not covered" >(_</span>props: StandardProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
	secondaryStartRect = this.leftPaneRef.current
		? <span class="branch-0 cbranch-no" title="branch not covered" >this.leftPaneRef.current.getBoundingClientRect()</span>
		: null;
&nbsp;
	getPanes = (): {
	...
	applyDeltaToSecondaryWidth = (
		...
		if (isExpanded) {
			(secondaryRef.current as HTMLDivElement).style.flexBasis = `${
				secondaryStartRect.width + dX * (secondary === right ? <span class="branch-0 cbranch-no" title="branch not covered" >-1 </span>: 1)
			}px`;
...
<span class="cstat-no" title="statement not covered" >				(secondaryRef.current as HTMLDivElement).style.flexBasis = `${</span>
...
&nbsp;
		...
		} else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="else path not taken" >E</span>if (!this.props.isExpanded &amp;&amp; isExpanded) {</span>
			// expand secondary
<span class="cstat-no" title="statement not covered" >			this.expandSecondary();</span>
		}
&nbsp;
