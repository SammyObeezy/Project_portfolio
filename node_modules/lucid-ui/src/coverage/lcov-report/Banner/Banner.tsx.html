...
<head>
    <title>Code coverage report for Banner/Banner.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Banner</a> Banner.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleClose = <span class="fstat-no" title="function not covered" >({</span>
		event,
		props,
	}: {
		event: React.MouseEvent;
...
<span class="cstat-no" title="statement not covered" >		onClose({ event, props });</span>
	};
&nbsp;
