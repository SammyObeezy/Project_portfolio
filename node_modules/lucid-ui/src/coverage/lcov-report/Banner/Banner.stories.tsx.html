...
<head>
    <title>Code coverage report for Banner/Banner.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Banner</a> Banner.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	return (
		&lt;div&gt;
			&lt;Button
				{...Button.defaultProps}
				onClick={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >setIsClosed(!isClosed)}</span>
...
&nbsp;
			&lt;br /&gt;
&nbsp;
			&lt;Banner {...args} isClosed={isClosed} onClose={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >setIsClosed(true)}</span>&gt;
				Default
			&lt;/Banner&gt;
		&lt;/div&gt;
	);
