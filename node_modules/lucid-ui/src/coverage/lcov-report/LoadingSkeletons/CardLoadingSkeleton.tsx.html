...
<head>
    <title>Code coverage report for LoadingSkeletons/CardLoadingSkeleton.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">LoadingSkeletons</a> CardLoadingSkeleton.tsx</h1>
        <div class='clearfix'>
...
export const CardSkeleton = (
	...
	const { width = <span class="branch-0 cbranch-no" title="branch not covered" >130,</span> height = <span class="branch-0 cbranch-no" title="branch not covered" >30,</span> className } = props;
&nbsp;
	return (
		&lt;div
