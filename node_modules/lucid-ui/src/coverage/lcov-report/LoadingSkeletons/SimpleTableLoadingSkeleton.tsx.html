...
<head>
    <title>Code coverage report for LoadingSkeletons/SimpleTableLoadingSkeleton.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">LoadingSkeletons</a> SimpleTableLoadingSkeleton.tsx</h1>
        <div class='clearfix'>
...
export const SimpleTableSkeleton = (
	...
	const { width = <span class="branch-0 cbranch-no" title="branch not covered" >880,</span> height = <span class="branch-0 cbranch-no" title="branch not covered" >50,</span> className } = props;
&nbsp;
	return (
