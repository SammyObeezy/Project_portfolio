...
<head>
    <title>Code coverage report for LoadingSkeletons/ComplexTableLoadingSkeleton.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">LoadingSkeletons</a> ComplexTableLoadingSkeleton.tsx</h1>
        <div class='clearfix'>
...
export const ComplexTableSkeleton = (
	...
	const { width = <span class="branch-0 cbranch-no" title="branch not covered" >860,</span> height = <span class="branch-0 cbranch-no" title="branch not covered" >92,</span> className } = props;
&nbsp;
	return (
