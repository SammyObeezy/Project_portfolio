...
<head>
    <title>Code coverage report for LoadingSkeletons/GroupLoadingSkeleton.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">LoadingSkeletons</a> GroupLoadingSkeleton.tsx</h1>
        <div class='clearfix'>
...
export const GroupSkeleton = (props: IStandardSkeleton): React.ReactElement =&gt; {
	const { width = <span class="branch-0 cbranch-no" title="branch not covered" >300,</span> height = <span class="branch-0 cbranch-no" title="branch not covered" >55,</span> className } = props;
&nbsp;
