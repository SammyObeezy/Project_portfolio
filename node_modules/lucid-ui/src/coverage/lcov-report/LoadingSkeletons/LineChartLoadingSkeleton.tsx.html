...
<head>
    <title>Code coverage report for LoadingSkeletons/LineChartLoadingSkeleton.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">LoadingSkeletons</a> LineChartLoadingSkeleton.tsx</h1>
        <div class='clearfix'>
...
export const LineChartSkeleton = (
	...
	const { width = <span class="branch-0 cbranch-no" title="branch not covered" >900,</span> height = <span class="branch-0 cbranch-no" title="branch not covered" >310,</span> className } = props;
&nbsp;
	return (
