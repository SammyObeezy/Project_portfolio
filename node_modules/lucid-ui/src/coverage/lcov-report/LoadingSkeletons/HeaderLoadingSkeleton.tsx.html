...
<head>
    <title>Code coverage report for LoadingSkeletons/HeaderLoadingSkeleton.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">LoadingSkeletons</a> HeaderLoadingSkeleton.tsx</h1>
        <div class='clearfix'>
...
export const HeaderSkeleton = (
	...
	const { width = <span class="branch-0 cbranch-no" title="branch not covered" >580,</span> height = <span class="branch-0 cbranch-no" title="branch not covered" >70,</span> className } = props;
	return (
