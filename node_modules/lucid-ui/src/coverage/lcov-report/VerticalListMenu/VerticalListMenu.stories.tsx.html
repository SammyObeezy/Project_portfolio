...
<head>
    <title>Code coverage report for VerticalListMenu/VerticalListMenu.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">VerticalListMenu</a> VerticalListMenu.stories.tsx</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { map, times, partial } from 'lodash';
...
export const NestedWithExpander: Story&lt;IVerticalListMenuProps&gt; = (args) =&gt; {
	...
	const handleSelect = <span class="fstat-no" title="function not covered" >(c</span>urrentList: string, index: number) =&gt; {
<span class="cstat-no" title="statement not covered" >		setCurrentList(currentList);</span>
<span class="cstat-no" title="statement not covered" >		setSelectedIndices([index]);</span>
	};
	return (
		&lt;VerticalListMenu
			{...(args as any)}
			...
			selectedIndices={currentList === 'one' ? selectedIndices : <span class="branch-1 cbranch-no" title="branch not covered" >[]}</span>
		&gt;
			&lt;VerticalListMenu.Item&gt;Level one&lt;/VerticalListMenu.Item&gt;
			&lt;VerticalListMenu.Item hasExpander={true}&gt;
				...
				&lt;VerticalListMenu
					...
					selectedIndices={currentList === 'two' ? <span class="branch-0 cbranch-no" title="branch not covered" >selectedIndices </span>: []}
				&gt;
					...
					&lt;VerticalListMenu.Item hasExpander={true}&gt;
						...
						&lt;VerticalListMenu
							...
							selectedIndices={currentList === 'three' ? <span class="branch-0 cbranch-no" title="branch not covered" >selectedIndices </span>: []}
						&gt;
							{times(20, (n) =&gt; {
								return (
				...
				&gt;
					...
					&lt;VerticalListMenu.Item isExpanded={false}&gt;
						...
						&lt;VerticalListMenu
							...
							selectedIndices={currentList === 'four' ? <span class="branch-0 cbranch-no" title="branch not covered" >selectedIndices </span>: []}
						&gt;
