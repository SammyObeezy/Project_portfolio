...
<head>
    <title>Code coverage report for VerticalListMenu/VerticalListMenu.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">VerticalListMenu</a> VerticalListMenu.tsx</h1>
        <div class='clearfix'>
								...
								&lt;div className={cx('&amp;-Item-content-body')}&gt;
									...
									{hasExpander ? (
										...
										&gt;
											&lt;ChevronIcon
												size={12}
												direction={actualIsExpanded ? <span class="branch-0 cbranch-no" title="branch not covered" >'up' </span>: 'down'}
											/&gt;
										&lt;/div&gt;
									) : null}
								&lt;/div&gt;
