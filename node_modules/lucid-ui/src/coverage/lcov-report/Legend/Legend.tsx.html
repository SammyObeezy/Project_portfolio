...
<head>
    <title>Code coverage report for Legend/Legend.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Legend</a> Legend.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
const LegendItem = <span class="fstat-no" title="function not covered" >(_</span>props: ILegendItemProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
&nbsp;
const handleItemClick = <span class="fstat-no" title="function not covered" >(</span>
	index: number,
	props: ILegendItemProps,
	event: React.MouseEvent&lt;HTMLLIElement&gt;
): void =&gt; {
	const { onClick } = <span class="cstat-no" title="statement not covered" >props;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	if (!onClick) {</span>
<span class="cstat-no" title="statement not covered" >		return;</span>
	}
&nbsp;
<span class="cstat-no" title="statement not covered" >	onClick(index, { props, event });</span>
};
&nbsp;
