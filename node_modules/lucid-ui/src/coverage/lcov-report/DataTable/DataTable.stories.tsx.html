...
<head>
    <title>Code coverage report for DataTable/DataTable.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">DataTable</a> DataTable.stories.tsx</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">69.91% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>79/113</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>77/110</span>
            </div>
...
<a name='L1496'></a><a href='#L1496'>1496</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { every, map, reverse, sortBy } from 'lodash';
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleSelect(_item: any, selectedIndex: any) {
			const { data } = <span class="cstat-no" title="statement not covered" >this.state;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >			this.setState({</span>
				data: map(data, <span class="fstat-no" title="function not covered" >(r</span>ow, rowIndex) =&gt; {
<span class="cstat-no" title="statement not covered" >					if (rowIndex === selectedIndex) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleSelectAll() {
			const { data } = <span class="cstat-no" title="statement not covered" >this.state;</span>
&nbsp;
			const allSelected = <span class="cstat-no" title="statement not covered" >every(data, 'isSelected');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >			this.setState({</span>
				data: map(data, <span class="fstat-no" title="function not covered" >(r</span>ow) =&gt; {
<span class="cstat-no" title="statement not covered" >					return {</span>
						...row,
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleRowClick(_item: any, rowIndex: any) {
<span class="cstat-no" title="statement not covered" >			this.setState({</span>
				activeIndex: rowIndex,
			});
		},
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleSort(field: any) {
...
<span class="cstat-no" title="statement not covered" >				currentlySortedField === field &amp;&amp; currentlySortedFieldDirection === 'up'</span>
					? 'down'
					: 'up';
			const nextData = <span class="cstat-no" title="statement not covered" >sortBy(data, field);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >			this.setState({</span>
...
&nbsp;
			return (
				&lt;DataTable
					{...args}
					data={map(data, <span class="fstat-no" title="function not covered" >(r</span>ow, index) =&gt;
<span class="cstat-no" title="statement not covered" >						index === activeIndex ? { ...row, isActive: true } : row</span>
					)}
					density='extended'
					isFullWidth
					anchorMessage
...
<span class="fstat-no" title="function not covered" >		ha</span>ndleToggle(stateItem: any) {
<span class="cstat-no" title="statement not covered" >			this.setState({ [stateItem]: !this.state[stateItem] });</span>
		},
<span class="fstat-no" title="function not covered" >		ha</span>ndleNumeric(stateItem: any, value: any) {
<span class="cstat-no" title="statement not covered" >			this.setState({ [stateItem]: value });</span>
		},
				...
				&lt;div&gt;
					&lt;label style={{ marginBottom: 6, display: 'block', fontSize: 12 }}&gt;
						&lt;TextField
							...
							onChangeDebounced={<span class="fstat-no" title="function not covered" >(v</span>) =&gt;
<span class="cstat-no" title="statement not covered" >								this.handleNumeric('fixedColumnCount', parseInt(v, 10))</span>
							}
					...
					&lt;label style={{ marginBottom: 6, display: 'block', fontSize: 12 }}&gt;
						&lt;TextField
							style={{ marginRight: 9, width: 45 }}
							onChangeDebounced={<span class="fstat-no" title="function not covered" >(v</span>) =&gt;
<span class="cstat-no" title="statement not covered" >								this.handleNumeric('fixedRowHeight', parseInt(v, 10))</span>
							}
					...
					&lt;CheckboxLabeled
						...
						onSelect={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleToggle('hasFixedHeader')}</span>
					/&gt;
					&lt;CheckboxLabeled
						Label='isSelectable'
						isSelected={this.state.isSelectable}
						onSelect={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleToggle('isSelectable')}</span>
					/&gt;
					&lt;CheckboxLabeled
						Label='hasLightHeader'
						isSelected={this.state.hasLightHeader}
						onSelect={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleToggle('hasLightHeader')}</span>
					/&gt;
					&lt;CheckboxLabeled
						Label='isActionable'
						isSelected={this.state.isActionable}
						onSelect={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleToggle('isActionable')}</span>
					/&gt;
...
<span class="fstat-no" title="function not covered" >		ha</span>ndleToggle(stateItem: any) {
<span class="cstat-no" title="statement not covered" >			this.setState(<span class="fstat-no" title="function not covered" >(p</span>revState: any) =&gt; (<span class="cstat-no" title="statement not covered" >{</span></span>
...
<span class="fstat-no" title="function not covered" >		on</span>ChangeFixedColumnCount(prarm: any) {
<span class="cstat-no" title="statement not covered" >			this.handleNumeric('fixedColumnCount', parseInt(prarm, 10));</span>
		},
<span class="fstat-no" title="function not covered" >		on</span>ChangeFixedRowHeight(prarm: any) {
<span class="cstat-no" title="statement not covered" >			this.handleNumeric('fixedRowHeight', parseInt(prarm, 10));</span>
		},
		renderDataTable(props: any) {
			return (
				&lt;DataTable data={data} {...props}&gt;
			...
			return (
				&lt;div&gt;
					&lt;label style={{ marginBottom: 6, display: 'block', fontSize: 12 }}&gt;
						&lt;TextField
							style={{ marginRight: 9, width: 45 }}
							onChange={<span class="fstat-no" title="function not covered" >(v</span>) =&gt; <span class="cstat-no" title="statement not covered" >this.onChangeFixedColumnCount(v)}</span>
							placeholder='fixedColumnCount'
							value={this.state.fixedColumnCount}
						/&gt;
						fixedColumnCount
					...
					&lt;label style={{ marginBottom: 6, display: 'block', fontSize: 12 }}&gt;
						&lt;TextField
							style={{ marginRight: 9, width: 45 }}
							onChange={<span class="fstat-no" title="function not covered" >(v</span>) =&gt; <span class="cstat-no" title="statement not covered" >this.onChangeFixedRowHeight(v)}</span>
							placeholder='fixedRowHeight'
							value={this.state.fixedRowHeight}
						/&gt;
						fixedRowHeight
