...
<head>
    <title>Code coverage report for DataTable/DataTable.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">DataTable</a> DataTable.tsx</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">93.47% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>86/92</span>
            </div>
...
<a name='L944'></a><a href='#L944'>944</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
	const handleFixedBodyUnfixedColumnsScroll = <span class="fstat-no" title="function not covered" >(e</span>vent: any) =&gt; {
<span class="cstat-no" title="statement not covered" >		fixedHeaderUnfixedColumnsRef &amp;&amp;</span>
			(fixedHeaderUnfixedColumnsRef.scrollLeft = event.target.scrollLeft);
<span class="cstat-no" title="statement not covered" >		fixedBodyFixedColumnsRef &amp;&amp;</span>
			(fixedBodyFixedColumnsRef.scrollTop = event.target.scrollTop);
	};
&nbsp;
	const handleResize = <span class="fstat-no" title="function not covered" >(c</span>olumnWidth: any, { props: { field } }: any) =&gt; {
		// setting latest column width to Tbody
<span class="cstat-no" title="statement not covered" >		setState(<span class="fstat-no" title="function not covered" >(s</span>tate) =&gt; (<span class="cstat-no" title="statement not covered" >{</span></span>
			activeWidth: {
				...state.activeWidth,
				[field]: columnWidth,
			},
					...
					{columnSlicer(
						[
							isSelectable ? (
								&lt;Th
									key={cx('&amp;-row-selector')}
									rowSpan={hasGroupedColumns ? <span class="branch-0 cbranch-no" title="branch not covered" >2 </span>: null}
							...
							_.map(childComponentElements, ({ props, type }, index) =&gt;
								type === DataTable.Column ? (
									&lt;Th
										...
										field={props.field || <span class="branch-1 cbranch-no" title="branch not covered" >index}</span>
							...
							[
								...
								_.map(
									...
									({ props: columnProps }, columnIndex) =&gt; {
										...
										const currentWidth =
											state.activeWidth[columnProps.field || <span class="branch-1 cbranch-no" title="branch not covered" >columnIndex]</span> ||
											columnProps.width;
										return (
											&lt;Td
												{..._.omit(columnProps, [
												...
												hasBorderRight={
													!_.isNil(columnProps.hasBorderRight)
														...
														: isFixedColumn &amp;&amp;
														  columnIndex + 1 + (isSelectable ? 1 : <span class="branch-1 cbranch-no" title="branch not covered" >0)</span> ===
																endColumn
												}
...
&nbsp;
const Column = <span class="fstat-no" title="function not covered" >(p</span>rops: IColumnProps) =&gt; {
...
&nbsp;
const ColumnGroup = <span class="fstat-no" title="function not covered" >({</span> children }: IColumnGroupProps) =&gt; {
