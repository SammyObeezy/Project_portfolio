...
<head>
    <title>Code coverage report for Typography/Typography.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Typography</a> Typography.tsx</h1>
        <div class='clearfix'>
...
export const Typography = (props: ITypographyProps) =&gt; {
	...
	const Element = ElementTypes[variant ? variant : <span class="branch-1 cbranch-no" title="branch not covered" >'p']</span>;
&nbsp;
