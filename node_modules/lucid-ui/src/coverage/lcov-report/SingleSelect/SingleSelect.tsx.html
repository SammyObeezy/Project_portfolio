...
<head>
    <title>Code coverage report for SingleSelect/SingleSelect.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SingleSelect</a> SingleSelect.tsx</h1>
        <div class='clearfix'>
...
<a name='L456'></a><a href='#L456'>456</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
const Placeholder = <span class="fstat-no" title="function not covered" >(_</span>props: ISingleSelectPlaceholderProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
&nbsp;
...
Selected.propTypes = {};
&nbsp;
const Option = <span class="fstat-no" title="function not covered" >(_</span>props: ISingleSelectOptionProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >	UN</span>SAFE_componentWillReceiveProps(nextProps: ISingleSelectProps): void {
		...
		const {
			...
			ungroupedOptionData,
			optionGroupDataLookup,
		} = <span class="cstat-no" title="statement not covered" >DropMenu.preprocessOptionData(nextProps, SingleSelect);</span>
&nbsp;
