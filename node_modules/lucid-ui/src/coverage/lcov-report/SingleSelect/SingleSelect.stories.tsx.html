...
<head>
    <title>Code coverage report for SingleSelect/SingleSelect.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SingleSelect</a> SingleSelect.stories.tsx</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { map, isNil } from 'lodash';
...
&nbsp;
	const handleSelect = <span class="fstat-no" title="function not covered" >(o</span>ptionIndex: number | null) =&gt; {
		const name = <span class="cstat-no" title="statement not covered" >!isNil(optionIndex)</span>
			? args.children[optionIndex].props.name
			: null;
<span class="cstat-no" title="statement not covered" >		setSelectedIndex(optionIndex);</span>
<span class="cstat-no" title="statement not covered" >		setSelectedOptionName(name);</span>
	};
&nbsp;
	return (
		&lt;section style={{ minHeight: '10em' }}&gt;
			&lt;SingleSelect {...args} onSelect={<span class="fstat-no" title="function not covered" >(e</span>) =&gt; <span class="cstat-no" title="statement not covered" >handleSelect(e)}</span>&gt;&lt;/SingleSelect&gt;
			{!isNil(selectedIndex) &amp;&amp; (
<span class="branch-1 cbranch-no" title="branch not covered" >				&lt;section style={{ paddingTop: 9, paddingLeft: 9 }}&gt;</span>
			...
			{selectedOptionName &amp;&amp; (
<span class="branch-1 cbranch-no" title="branch not covered" >				&lt;section style={{ paddingLeft: 9 }}&gt;</span>
...
&nbsp;
/** Formatted Options */
const OptionCols = <span class="fstat-no" title="function not covered" >({</span> col1, col2 }: { col1: string; col2: string }) =&gt; (
