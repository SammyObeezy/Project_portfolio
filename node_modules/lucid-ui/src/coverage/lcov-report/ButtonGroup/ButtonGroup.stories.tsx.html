...
<head>
    <title>Code coverage report for ButtonGroup/ButtonGroup.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ButtonGroup</a> ButtonGroup.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleSelect = <span class="fstat-no" title="function not covered" >(s</span>electedIndex: number, { event, props }) =&gt; {
		const currentIndices = <span class="cstat-no" title="statement not covered" >selectedIndices;</span>
		// If the item does not exist in the original array add it, if it exists remove it.
<span class="cstat-no" title="statement not covered" >		setSelectedIndices(_.xor(currentIndices, [selectedIndex]));</span>
	};
&nbsp;
	return (
		&lt;ButtonGroup
...
export const OnClick: Story&lt;IButtonGroupProps&gt; = (args) =&gt; {
	const handleClick = <span class="fstat-no" title="function not covered" >(l</span>abel) =&gt; {
<span class="cstat-no" title="statement not covered" >		alert(label);</span>
	};
&nbsp;
	return (
		&lt;ButtonGroup {...args}&gt;
			&lt;ButtonGroup.Button onClick={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >handleClick('Zero')}</span>&gt;
				Zero
			&lt;/ButtonGroup.Button&gt;
			&lt;ButtonGroup.Button onClick={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >handleClick('One')}</span>&gt;
				One
			&lt;/ButtonGroup.Button&gt;
		&lt;/ButtonGroup&gt;
	);
