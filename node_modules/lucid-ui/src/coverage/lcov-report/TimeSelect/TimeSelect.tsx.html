...
<head>
    <title>Code coverage report for TimeSelect/TimeSelect.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">TimeSelect</a> TimeSelect.tsx</h1>
        <div class='clearfix'>
...
const TimeSelect = ({
	...
	const { hour, meridiem = MeridiemType.AM } = useMemo(() =&gt; {
		...
		const cleanedHour =
			hour === 0 || hour === 12 ? <span class="branch-0 cbranch-no" title="branch not covered" >12 </span>: hour &lt; 12 ? <span class="branch-0 cbranch-no" title="branch not covered" >hour </span>: hour - 12;
		const cleanedMeridiem = hour &lt; 12 ? <span class="branch-0 cbranch-no" title="branch not covered" >MeridiemType.AM </span>: MeridiemType.PM;
		return { hour: cleanedHour, meridiem: cleanedMeridiem };
	}, [time, is24HourClock]);
&nbsp;
	const isAM = useMemo(() =&gt; meridiem === MeridiemType.AM, [meridiem]);
	const isDisabledClass = isDisabled ? <span class="branch-0 cbranch-no" title="branch not covered" >'&amp;-time-disabled' </span>: '';
	const timeSelectorClass = isDisabled ? <span class="branch-0 cbranch-no" title="branch not covered" >'&amp;-isDisabled' </span>: '';
&nbsp;
	const toggleInputFocus = <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >setInputFocus(!inputFocus);</span>
&nbsp;
	return (
		&lt;div
