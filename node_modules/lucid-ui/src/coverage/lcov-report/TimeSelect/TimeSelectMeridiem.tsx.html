...
<head>
    <title>Code coverage report for TimeSelect/TimeSelectMeridiem.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">TimeSelect</a> TimeSelectMeridiem.tsx</h1>
        <div class='clearfix'>
...
const TimeSelectMeridiem = ({
	...
	const onMeridiemChange = useCallback(
		(selectedIndex) =&gt; {
			...
			<span class="missing-if-branch" title="if path not taken" >I</span>if (meridiem === nextMeridiem) {
<span class="cstat-no" title="statement not covered" >				return;</span>
			}
			const updatedTime = new Date(time);
			if (nextMeridiem === MeridiemType.AM) {
				updatedTime.setHours(hour === 12 ? <span class="branch-0 cbranch-no" title="branch not covered" >0 </span>: hour);
			} else {
				updatedTime.setHours(hour === 12 ? <span class="branch-0 cbranch-no" title="branch not covered" >hour </span>: hour + 12);
			}
