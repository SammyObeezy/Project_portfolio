...
<head>
    <title>Code coverage report for TimeSelect/TimeSelectHour.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">TimeSelect</a> TimeSelectHour.tsx</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import React, { useCallback } from 'react';
...
const getCleanedHour = (partialCleanedHour: number) =&gt; {
	return partialCleanedHour &lt; 0
		? <span class="branch-0 cbranch-no" title="branch not covered" >23</span>
		: partialCleanedHour &gt; 23
		? <span class="branch-0 cbranch-no" title="branch not covered" >0</span>
		: partialCleanedHour;
};
&nbsp;
const getCleanedAMHour = <span class="fstat-no" title="function not covered" >(n</span>extHour: number) =&gt; {
	const partialCleanedHour =
<span class="cstat-no" title="statement not covered" >		nextHour &gt; 12 ? nextHour - 12 : nextHour &lt; 0 ? nextHour + 12 : nextHour;</span>
<span class="cstat-no" title="statement not covered" >	return getCleanedHour(partialCleanedHour);</span>
};
const getCleanedPMHour = (nextHour: number) =&gt; {
	const partialCleanedHour =
		nextHour === 12 ? <span class="branch-0 cbranch-no" title="branch not covered" >12 </span>: nextHour &gt; 12 ? <span class="branch-0 cbranch-no" title="branch not covered" >nextHour </span>: nextHour + 12;
		...
		(nextHourString) =&gt; {
			...
			if (is24HourClock) {
				...
				if (shouldRollOver) {
					...
					cleanedHour = isAM
						? <span class="branch-0 cbranch-no" title="branch not covered" >getCleanedAMHour(nextHour)</span>
