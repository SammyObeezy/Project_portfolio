...
<head>
    <title>Code coverage report for LoadingIndicator/LoadingIndicator.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">LoadingIndicator</a> LoadingIndicator.stories.tsx</h1>
        <div class='clearfix'>
...
export const Interactive: Story&lt;ILoadingIndicatorProps&gt; = (args) =&gt; {
	...
	const getData = <span class="fstat-no" title="function not covered" >()</span> =&gt;
<span class="cstat-no" title="statement not covered" >		_.map(dates, <span class="fstat-no" title="function not covered" >(d</span>ate) =&gt; (<span class="cstat-no" title="statement not covered" >{ x: date, y: _.random(1, 5) })</span>);</span>
&nbsp;
...
&nbsp;
	const handleOverlayKindClick = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
...
&nbsp;
	useEffect(<span class="fstat-no" title="function not covered" >()</span> =&gt; {
		const removeIsLoading = <span class="cstat-no" title="statement not covered" >setTimeout(</span>
<span class="fstat-no" title="function not covered" >			()</span> =&gt; <span class="cstat-no" title="statement not covered" >setState({ ...state, isLoading: false, data: getData() }),</span>
			1000
		);
<span class="cstat-no" title="statement not covered" >		return <span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >			clearTimeout(removeIsLoading);</span>
		};
	}, []);
&nbsp;
	return (
...
<span class="cstat-no" title="statement not covered" >					setState({ ...state, isLoading: true });</span>
