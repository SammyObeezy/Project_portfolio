...
<head>
    <title>Code coverage report for SearchableSingleSelect/SearchableSingleSelect.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SearchableSingleSelect</a> SearchableSingleSelect.tsx</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">87.77% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>79/90</span>
            </div>
...
&nbsp;
const Option = <span class="fstat-no" title="function not covered" >(_</span>props: ISearchableSingleSelectOptionProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
&nbsp;
...
<span class="fstat-no" title="function not covered" >	UN</span>SAFE_componentWillReceiveProps(
		...
		const {
			...
			ungroupedOptionData,
			optionGroupDataLookup,
		} = <span class="cstat-no" title="statement not covered" >DropMenu.preprocessOptionData(nextProps, SearchableSingleSelect);</span>
&nbsp;
...
&nbsp;
	renderUnderlinedChildren = <span class="fstat-no" title="function not covered" >(c</span>hildText: string, searchText: string): any[] =&gt; {
					...
					&lt;Selection
						Label={
							_.isNil(selectedOptionProps.Selected)
								...
								: <span class="branch-1 cbranch-no" title="branch not covered" >selectedOptionProps.Selected</span>
						}
						className={cx(
							'&amp;',
							{
...
<span class="branch-2 cbranch-no" title="branch not covered" >									errorChildProps.children !== true,</span>
							},
							className
						)}
					...
					errorChildProps.children &amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >					errorChildProps.children !== true </span>? (
<span class="branch-0 cbranch-no" title="branch not covered" >						&lt;div</span>
