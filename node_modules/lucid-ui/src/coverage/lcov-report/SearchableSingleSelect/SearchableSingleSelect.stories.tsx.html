...
<head>
    <title>Code coverage report for SearchableSingleSelect/SearchableSingleSelect.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SearchableSingleSelect</a> SearchableSingleSelect.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleSearch = <span class="fstat-no" title="function not covered" >(s</span>earchText) =&gt; {
...
<span class="cstat-no" title="statement not covered" >		setTimeout(<span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
			const searchResults = <span class="cstat-no" title="statement not covered" >reduce(</span>
				allData,
<span class="fstat-no" title="function not covered" >				(a</span>cc: any[], { name }: { name: string }, id: string) =&gt; {
<span class="cstat-no" title="statement not covered" >					return includes(name.toLowerCase(), searchText.toLowerCase())</span>
						? acc.concat(id)
						: acc;
				},
				[]
...
<span class="cstat-no" title="statement not covered" >			setVisibleIds(searchResults);</span>
		});
	};
&nbsp;
	const handleSelect = <span class="fstat-no" title="function not covered" >(i</span>ndex: string, event: any) =&gt; {
		const optionsId = <span class="cstat-no" title="statement not covered" >get(event, 'props.callbackId', null);</span>
<span class="cstat-no" title="statement not covered" >		setSelectedId(optionsId);</span>
	};
&nbsp;
	const selectedIndex =
		indexOf(visibleIds, selectedId) === -1
			? null
			: <span class="branch-1 cbranch-no" title="branch not covered" >indexOf(visibleIds, selectedId);</span>
&nbsp;
	return (
		&lt;section&gt;
			&lt;SearchableSingleSelect
			...
			&gt;
				{map(visibleIds, <span class="fstat-no" title="function not covered" >(i</span>d) =&gt; (
...
&nbsp;
	const handleSelect = <span class="fstat-no" title="function not covered" >(o</span>ptionIndex: number | null) =&gt; {
<span class="cstat-no" title="statement not covered" >		setSelectedIndex(optionIndex);</span>
	};
&nbsp;
	return (
		&lt;SearchableSingleSelect
			onSelect={handleSelect}
			Error={selectedIndex === 2 ? <span class="branch-0 cbranch-no" title="branch not covered" >null </span>: 'Please Choose Green'}
		&gt;
			&lt;Option Selected={&lt;div style={{ color: 'red' }}&gt;RED&lt;/div&gt;}&gt;Red&lt;/Option&gt;
			&lt;Option Selected={&lt;div style={{ color: 'blue' }}&gt;BLUE&lt;/div&gt;}&gt;Blue&lt;/Option&gt;
			&lt;Option Selected={&lt;div style={{ color: 'green' }}&gt;GREEN&lt;/div&gt;}&gt;
...
&nbsp;
/** Formatted Options */
const OptionCols = <span class="fstat-no" title="function not covered" >({</span>
	col1,
	col2,
	col3,
	textMatch,
...
<span class="cstat-no" title="statement not covered" >					&lt;OptionCols</span>
						col1='13'
						col2='Drone'
