...
<head>
    <title>Code coverage report for CalendarMonth/CalendarMonth.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">CalendarMonth</a> CalendarMonth.tsx</h1>
        <div class='clearfix'>
		...
		if (cursor) {
			if (selectMode === 'day') {
				...
				return DateUtils.isDayInRange(day, {
					from: new Date(selectMode === 'to' ? (from as Date) : (<span class="branch-1 cbranch-no" title="branch not covered" >to as Date)</span>),
					to: new Date(cursor),
				});
			}
			return DateUtils.isSameDay(day, new Date(cursor));
