...
<head>
    <title>Code coverage report for CalendarMonth/CalendarMonth.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">CalendarMonth</a> CalendarMonth.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndlePrev() {
<span class="cstat-no" title="statement not covered" >			this.setState({</span>
				offset: this.state.offset - 1,
			});
		},
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleNext() {
<span class="cstat-no" title="statement not covered" >			this.setState({</span>
				offset: this.state.offset + 1,
			});
		},
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleDayClick(date: any, { disabled }: any) {
<span class="cstat-no" title="statement not covered" >			if (disabled) {</span>
<span class="cstat-no" title="statement not covered" >				return;</span>
			}
&nbsp;
			const { selectedDays } = <span class="cstat-no" title="statement not covered" >this.state;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >			this.setState({</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleDayMouseEnter(day: any, { disabled }: any) {
<span class="cstat-no" title="statement not covered" >			if (disabled) {</span>
<span class="cstat-no" title="statement not covered" >				this.setState({</span>
					cursor: null,
				});
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleDayMouseLeave() {
<span class="cstat-no" title="statement not covered" >			this.setState({</span>
				cursor: null,
			});
		},
...
&nbsp;
					...
					&lt;/div&gt;
					selectedDays:{' '}
					{_.map(selectedDays, <span class="fstat-no" title="function not covered" >(s</span>elected) =&gt;
<span class="cstat-no" title="statement not covered" >						selected.toLocaleDateString('en-US')</span>
					).join(', ')}
				&lt;/section&gt;
			);
		},
...
&nbsp;
			const { selectMode } = <span class="cstat-no" title="statement not covered" >this.state;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >			if (selectMode === 'to') {</span>
<span class="cstat-no" title="statement not covered" >				this.setState({</span>
					to: date,
					cursor: date,
				});
...
&nbsp;
						&lt;Button onClick={this.handleNext}&gt;{'&gt;'}&lt;/Button&gt;
					&lt;/div&gt;
					from: {from &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >from.toLocaleDateString('en-US')}</span>, to:{' '}
					{to &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >to.toLocaleDateString('en-US')}</span>
				&lt;/section&gt;
			);
		},
	});
