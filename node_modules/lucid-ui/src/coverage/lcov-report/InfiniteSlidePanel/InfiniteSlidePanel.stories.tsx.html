...
<head>
    <title>Code coverage report for InfiniteSlidePanel/InfiniteSlidePanel.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">InfiniteSlidePanel</a> InfiniteSlidePanel.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handlePrev = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >		setOffset(offset - 1);</span>
	};
&nbsp;
	const handleNext = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >		setOffset(offset + 1);</span>
	};
&nbsp;
	const handleSwipe = <span class="fstat-no" title="function not covered" >(s</span>lidesSwiped: any) =&gt; {
<span class="cstat-no" title="statement not covered" >		setOffset(offset + slidesSwiped);</span>
	};
&nbsp;
	return (
		&lt;section&gt;
