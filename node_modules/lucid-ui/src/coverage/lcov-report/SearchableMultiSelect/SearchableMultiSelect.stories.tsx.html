...
<head>
    <title>Code coverage report for SearchableMultiSelect/SearchableMultiSelect.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SearchableMultiSelect</a> SearchableMultiSelect.stories.tsx</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">66.17% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>45/68</span>
            </div>
...
&nbsp;
	return (
		&lt;Resizer&gt;
			{(width) =&gt; {
				const responsiveMode = width &gt;= 768 ? <span class="branch-0 cbranch-no" title="branch not covered" >'large' </span>: 'small';
&nbsp;
				return (
					&lt;section&gt;
						&lt;h5&gt;Loading&lt;/h5&gt;
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleSearch(searchText: string) {
<span class="cstat-no" title="statement not covered" >			this.setState({ isLoading: true });</span>
&nbsp;
			// Fake an API call
<span class="cstat-no" title="statement not covered" >			setTimeout(<span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
				const visibleIds = <span class="cstat-no" title="statement not covered" >_.reduce(</span>
					allData,
<span class="fstat-no" title="function not covered" >					(a</span>cc: any[], { name }: { name: string }, id: string) =&gt; {
<span class="cstat-no" title="statement not covered" >						return _.includes(name.toLowerCase(), searchText.toLowerCase())</span>
							? acc.concat(id)
							: acc;
					},
					[]
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleRemove({
			props: { callbackId },
		}: {
			props: {
				callbackId: string;
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleSelect(
			index: number,
			{
				props: { callbackId },
			}: {
...
&nbsp;
			...
			const selectedIndices = _.reduce(
				visibleIds,
<span class="fstat-no" title="function not covered" >				(a</span>cc: any[], id: string, index: number) =&gt; {
<span class="cstat-no" title="statement not covered" >					return _.includes(selectedIds, id) ? acc.concat(index) : acc;</span>
				},
				[]
			);
&nbsp;
			return (
				&lt;section&gt;
					...
					&gt;
						{_.map(visibleIds, <span class="fstat-no" title="function not covered" >(i</span>d) =&gt; (
<span class="cstat-no" title="statement not covered" >							&lt;Option key={id} callbackId={id}&gt;</span>
								{allData[id].name}
							&lt;/Option&gt;
						))}
					&lt;/SearchableMultiSelect&gt;
...
<span class="branch-0 cbranch-no" title="branch not covered" >						&lt;Selection</span>
							isBold
							hasBackground
							Label='Selected'
							kind='container'
							isRemovable={false}
						&gt;
							{_.map(selectedIds, <span class="fstat-no" title="function not covered" >(i</span>d) =&gt; (
...
export const FormattedOptions: Story&lt;ISearchableMultiSelectProps&gt; = (args) =&gt; {
	...
	function <span class="fstat-no" title="function not covered" >P(</span>{ children, ...rest }: Props) {
<span class="cstat-no" title="statement not covered" >		return &lt;p {...rest}&gt;{children}&lt;/p&gt;;</span>
	}
&nbsp;
	const OptionCols: any = <span class="fstat-no" title="function not covered" >({</span>
		col1,
		col2,
		textMatch,
	}: {
...
<span class="cstat-no" title="statement not covered" >		&lt;div style={{ display: 'flex' }}&gt;</span>
			&lt;div style={{ width: 100 }}&gt;
...
&nbsp;
				&lt;SearchableMultiSelect.Option filterText='Foo' Selected='Foo (1234)'&gt;
					{<span class="fstat-no" title="function not covered" >({</span> searchText }: { searchText: string }) =&gt; (
<span class="cstat-no" title="statement not covered" >						&lt;OptionCols col1='1234' col2='Foo' textMatch={searchText} /&gt;</span>
					)}
				&lt;/SearchableMultiSelect.Option&gt;
&nbsp;
				&lt;SearchableMultiSelect.Option filterText='Bar' Selected='Bar (2345)'&gt;
					{<span class="fstat-no" title="function not covered" >({</span> searchText }: { searchText: string }) =&gt; (
<span class="cstat-no" title="statement not covered" >						&lt;OptionCols col1='2345' col2='Bar' textMatch={searchText} /&gt;</span>
					)}
				&lt;/SearchableMultiSelect.Option&gt;
&nbsp;
				&lt;SearchableMultiSelect.Option filterText='Baz' Selected='Baz (3456)'&gt;
					{<span class="fstat-no" title="function not covered" >({</span> searchText }: { searchText: string }) =&gt; (
<span class="cstat-no" title="statement not covered" >						&lt;OptionCols col1='3456' col2='Baz' textMatch={searchText} /&gt;</span>
					)}
				&lt;/SearchableMultiSelect.Option&gt;
...
&nbsp;
	const handleChange = <span class="fstat-no" title="function not covered" >(o</span>ption: string, event: any) =&gt; {
		let count = <span class="cstat-no" title="statement not covered" >selectedLength;</span>
<span class="cstat-no" title="statement not covered" >		if (typeof event.props.children === 'string') {</span>
<span class="cstat-no" title="statement not covered" >			count--;</span>
		} else {
<span class="cstat-no" title="statement not covered" >			event.props.children.props.isSelected ? count-- : count++;</span>
		}
<span class="cstat-no" title="statement not covered" >		setSelectedLength(count);</span>
	};
&nbsp;
	const handleRemoveAll = <span class="fstat-no" title="function not covered" >(o</span>ption: string, event: any) =&gt; {
<span class="cstat-no" title="statement not covered" >		setSelectedLength(0);</span>
	};
&nbsp;
	return (
		&lt;SearchableMultiSelect
			...
			Error={selectedLength &gt; 1 ? <span class="branch-0 cbranch-no" title="branch not covered" >null </span>: 'Please select at least two options'}
		&gt;
			&lt;Option&gt;Alabama&lt;/Option&gt;
			&lt;Option&gt;Alaska&lt;/Option&gt;
			&lt;Option&gt;Arizona&lt;/Option&gt;
