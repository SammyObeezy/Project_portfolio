...
<head>
    <title>Code coverage report for SearchableMultiSelect/SearchableMultiSelect.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SearchableMultiSelect</a> SearchableMultiSelect.tsx</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">92.48% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>123/133</span>
            </div>
...
<a name='L994'></a><a href='#L994'>994</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* eslint-disable react/prop-types */
...
const SelectionOption = <span class="fstat-no" title="function not covered" >(_</span>props: ISelectionProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
const Selected = <span class="fstat-no" title="function not covered" >(_</span>props: { children?: React.ReactNode }): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
const OptionGroup = <span class="fstat-no" title="function not covered" >(_</span>props: ISearchableSingleSelectOptionGroupProps): null =&gt;
...
const SearchFieldComponent = <span class="fstat-no" title="function not covered" >(_</span>props: ISearchFieldProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
const Option = <span class="fstat-no" title="function not covered" >(_</span>props: ISearchableMultiSelectOptionProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
&nbsp;
...
&nbsp;
		const trueIndex = firstVisibleIndex === -1 ? <span class="branch-0 cbranch-no" title="branch not covered" >-1 </span>: firstVisibleIndex + 1;
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >	UN</span>SAFE_componentWillReceiveProps(
		...
		const {
			...
			ungroupedOptionData,
			optionGroupDataLookup,
		} = <span class="cstat-no" title="statement not covered" >DropMenu.preprocessOptionData(nextProps, SearchableMultiSelect);</span>
&nbsp;
...
&nbsp;
		return [
			pre &amp;&amp; (
<span class="branch-1 cbranch-no" title="branch not covered" >				&lt;span key='pre' className={cx('&amp;-Option-underline-pre')}&gt;</span>
					{pre}
				&lt;/span&gt;
			),
			match &amp;&amp; (
<span class="branch-1 cbranch-no" title="branch not covered" >				&lt;span key='match' className={cx('&amp;-Option-underline-match')}&gt;</span>
					{match}
				&lt;/span&gt;
			),
			post &amp;&amp; (
...
<span class="branch-1 cbranch-no" title="branch not covered" >			&lt;SearchableMultiSelect.SelectionLabel&gt;</span>
				Selected
			...
			&gt;
				&lt;DropMenu
					...
					optionContainerStyle={_.assign(
						...
						!_.isNil(maxMenuHeight) ? <span class="branch-0 cbranch-no" title="branch not covered" >{ maxHeight: maxMenuHeight } </span>: null
					)}
...
&nbsp;
				{hasSelections &amp;&amp; !_.isEmpty(selectedIndices) ? (
					&lt;div className={cx('&amp;-Selection-padding')}&gt;
						...
						&gt;
							&lt;Selection.Label&gt;
								{selectionLabel.children ? <span class="branch-0 cbranch-no" title="branch not covered" >selectionLabel.children </span>: 'Selected'}
							&lt;/Selection.Label&gt;
							{_.map(
								optionGroupDataLookup,
															...
															&gt;
																&lt;Selection.Label&gt;
																	{_.get(
																		...
																		(_.isFunction(optionProps.children)
																			? <span class="branch-0 cbranch-no" title="branch not covered" >React.createElement(</span>
																					optionProps.children
																			  )
																			: optionProps.children)}
																&lt;/Selection.Label&gt;
										...
										&gt;
											&lt;Selection.Label&gt;
												{_.get(
													...
													(_.isFunction(optionProps.children)
														? <span class="branch-0 cbranch-no" title="branch not covered" >React.createElement(optionProps.children)</span>
														: optionProps.children)}
											&lt;/Selection.Label&gt;
										&lt;/Selection&gt;
									);
