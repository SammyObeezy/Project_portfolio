...
<head>
    <title>Code coverage report for TextFieldValidated/TextFieldValidated.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">TextFieldValidated</a> TextFieldValidated.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
const TextFieldValidatedError = <span class="fstat-no" title="function not covered" >(_</span>props: ITextFieldValidatedErrorProps): null =&gt;
...
<span class="cstat-no" title="statement not covered" >		this.textFieldRef.current &amp;&amp; this.textFieldRef.current.focus();</span>
	};
&nbsp;
	render() {
