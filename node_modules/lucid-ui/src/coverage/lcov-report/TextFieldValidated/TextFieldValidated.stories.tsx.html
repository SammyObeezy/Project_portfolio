...
<head>
    <title>Code coverage report for TextFieldValidated/TextFieldValidated.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">TextFieldValidated</a> TextFieldValidated.stories.tsx</h1>
        <div class='clearfix'>
	...
	return (
		&lt;div&gt;
			&lt;TextFieldValidated
				...
				Error={value === 'foo' ? <span class="branch-0 cbranch-no" title="branch not covered" >null </span>: 'Please enter "foo"'}
			/&gt;
		&lt;/div&gt;
	);
};
	...
	return (
		&lt;div&gt;
			&lt;TextFieldValidated
				...
				style={style}
				value={value}
				onChangeDebounced={<span class="fstat-no" title="function not covered" >()</span> =&gt; {}}
