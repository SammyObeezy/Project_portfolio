...
<head>
    <title>Code coverage report for Switch/Switch.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Switch</a> Switch.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleSelect = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >		setSelected(!selected);</span>
	};
&nbsp;
