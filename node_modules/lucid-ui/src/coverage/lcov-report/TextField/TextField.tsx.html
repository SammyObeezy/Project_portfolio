...
<head>
    <title>Code coverage report for TextField/TextField.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">TextField</a> TextField.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	private releaseHold = _.debounce((): void =&gt; {
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!this.state.isMounted) {
...
<span class="cstat-no" title="statement not covered" >			this.updateWhenReady(newValue);</span>
