...
<head>
    <title>Code coverage report for TextField/TextField.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">TextField</a> TextField.stories.tsx</h1>
        <div class='clearfix'>
	...
	return (
		&lt;div&gt;
			&lt;TextField
				...
				placeholder='default'
				value={value}
				onChange={<span class="fstat-no" title="function not covered" >(v</span>alue) =&gt; <span class="cstat-no" title="statement not covered" >setValue(value)}</span>
			/&gt;
		&lt;/div&gt;
	);
};
	...
	return (
		&lt;div&gt;
			&lt;TextField
				...
				style={style}
				value={value}
				onSubmit={<span class="fstat-no" title="function not covered" >(v</span>alue) =&gt; <span class="cstat-no" title="statement not covered" >setValue(value)}</span>
			/&gt;
