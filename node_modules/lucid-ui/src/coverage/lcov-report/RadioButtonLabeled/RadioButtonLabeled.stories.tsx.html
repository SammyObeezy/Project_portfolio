...
<head>
    <title>Code coverage report for RadioButtonLabeled/RadioButtonLabeled.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">RadioButtonLabeled</a> RadioButtonLabeled.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleSelectedFlavor = <span class="fstat-no" title="function not covered" >(f</span>lavor: string) =&gt; {
<span class="cstat-no" title="statement not covered" >		setFlavor(flavor);</span>
	};
&nbsp;
	return (
		&lt;section&gt;
			...
			&gt;
				&lt;RadioButtonLabeled
					...
					onSelect={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >handleSelectedFlavor('vanilla')}</span>
					style={style}
				&gt;
				...
				&lt;RadioButtonLabeled
					...
					name='interactive-radio-buttons'
					onSelect={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >handleSelectedFlavor('chocolate')}</span>
					style={style}
				&gt;
				...
				&lt;RadioButtonLabeled
					...
					name='interactive-radio-buttons'
					onSelect={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >handleSelectedFlavor('strawberry')}</span>
					style={style}
				&gt;
				...
				&lt;RadioButtonLabeled
					...
					name='interactive-radio-buttons'
					onSelect={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >handleSelectedFlavor('saltedCaramel')}</span>
					style={style}
				&gt;
				...
				&lt;RadioButtonLabeled
					...
					name='interactive-radio-buttons'
					onSelect={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >handleSelectedFlavor('mintChip')}</span>
					style={style}
				&gt;
