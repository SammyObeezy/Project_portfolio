...
<head>
    <title>Code coverage report for Icon/MinusCircleLightIcon/MinusCircleLightIcon.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">Icon/MinusCircleLightIcon</a> MinusCircleLightIcon.tsx</h1>
        <div class='clearfix'>
	...
	return (
		&lt;Icon
			...
			className={cx(
				...
				isActive &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >'&amp;-is-active',</span>
				className
			)}
		&gt;
