...
<head>
    <title>Code coverage report for Icon/LoadingIcon/LoadingIcon.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">Icon/LoadingIcon</a> LoadingIcon.tsx</h1>
        <div class='clearfix'>
...
export const LoadingIcon = ({
	...
	const animationDuration = `${durations[speed] || <span class="branch-1 cbranch-no" title="branch not covered" >durations.normal}</span>`;
&nbsp;
	return (
		&lt;Icon
