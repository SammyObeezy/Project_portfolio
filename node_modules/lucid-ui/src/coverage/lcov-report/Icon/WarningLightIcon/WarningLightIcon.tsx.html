...
<head>
    <title>Code coverage report for Icon/WarningLightIcon/WarningLightIcon.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">Icon/WarningLightIcon</a> WarningLightIcon.tsx</h1>
        <div class='clearfix'>
...
export const WarningLightIcon = ({
	...
	return (
		&lt;Icon
			...
			className={cx(
				'&amp;',
				isDisabled &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >'&amp;-is-disabled',</span>
