...
<head>
    <title>Code coverage report for Icon/EligibilityLightIcon/EligibilityLightIcon.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">Icon/EligibilityLightIcon</a> EligibilityLightIcon.tsx</h1>
        <div class='clearfix'>
...
export const EligibilityLightIcon = ({
	className,
	eligibility = 'neither',
	isDisabled = <span class="branch-0 cbranch-no" title="branch not covered" >false,</span>
	...passThroughs
