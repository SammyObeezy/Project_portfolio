...
<head>
    <title>Code coverage report for Bars/Bars.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Bars</a> Bars.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	handleMouseEnter = <span class="fstat-no" title="function not covered" >(h</span>overingSeriesIndex: number) =&gt; {
<span class="cstat-no" title="statement not covered" >		this.setState({</span>
			hoveringSeriesIndex,
		});
	};
&nbsp;
	handleMouseOut = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >		this.setState({ hoveringSeriesIndex: null });</span>
	};
&nbsp;
	static defaultProps = {
		hasToolTips: true,
...
&nbsp;
	handleMouseEnter = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >		this.props.onMouseEnter(this.props.seriesIndex);</span>
	};
&nbsp;
