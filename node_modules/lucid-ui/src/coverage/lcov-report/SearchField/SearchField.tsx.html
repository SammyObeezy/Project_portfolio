...
<head>
    <title>Code coverage report for SearchField/SearchField.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SearchField</a> SearchField.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
const SearchFieldIcon = <span class="fstat-no" title="function not covered" >(_</span>props: ISearchFieldIcon): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
const SearchFieldTextField = <span class="fstat-no" title="function not covered" >(_</span>props: ISearchFieldTextField): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
	focus = <span class="fstat-no" title="function not covered" >(o</span>ptions?: FocusOptions): void =&gt; {
<span class="cstat-no" title="statement not covered" >		this.textFieldElement.current &amp;&amp;</span>
