...
<head>
    <title>Code coverage report for SearchField/SearchField.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SearchField</a> SearchField.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	return (
		&lt;div&gt;
			&lt;SearchField {...args} onSubmit={<span class="fstat-no" title="function not covered" >(v</span>alue) =&gt; <span class="cstat-no" title="statement not covered" >setState(value)}</span> /&gt;
		...
		&lt;div&gt;
			&lt;SearchField {...args} placeholder='Name/ID'&gt;
				&lt;SearchField.TextField
					value={state.value}
					onSubmit={<span class="fstat-no" title="function not covered" >(s</span>ubmission) =&gt; <span class="cstat-no" title="statement not covered" >setState({ ...state, submission })}</span>
					onChange={<span class="fstat-no" title="function not covered" >(v</span>alue) =&gt; <span class="cstat-no" title="statement not covered" >setState({ ...state, value })}</span>
					onKeyDown={<span class="fstat-no" title="function not covered" >({</span> event: { key } }) =&gt; <span class="cstat-no" title="statement not covered" >setKey(key)}</span>
					onBlur={<span class="fstat-no" title="function not covered" >(l</span>astValue) =&gt; <span class="cstat-no" title="statement not covered" >setState({ ...state, lastValue })}</span>
				/&gt;
			&lt;/SearchField&gt;
			&lt;div style={{ marginTop: '10px', marginLeft: '10px' }}&gt;
	...
	return (
		&lt;div&gt;
			&lt;SearchField
				...
				value={value}
				onChangeDebounced={<span class="fstat-no" title="function not covered" >(v</span>alue) =&gt; <span class="cstat-no" title="statement not covered" >setValue(value)}</span>
			/&gt;
			&lt;div
				style={{
					marginBottom: '10px',
...
<span class="cstat-no" title="statement not covered" >					setValue('foo');</span>
				}}
			&gt;
