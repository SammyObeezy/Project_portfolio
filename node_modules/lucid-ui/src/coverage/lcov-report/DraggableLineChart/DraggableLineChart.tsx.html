...
<head>
    <title>Code coverage report for DraggableLineChart/DraggableLineChart.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">DraggableLineChart</a> DraggableLineChart.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
const getEmptyRenderProp = <span class="fstat-no" title="function not covered" >(p</span>reSelectText: string) =&gt; (
...
const getCleanData = (data: IData): IData =&gt; {
	return data.map(({ x, y }) =&gt; ({ x, y: Number.isFinite(y) ? y : <span class="branch-1 cbranch-no" title="branch not covered" >0 </span>}));
};
&nbsp;
	...
	componentDidMount() {
		...
		const emptyRenderProp =
			onPreselect &amp;&amp; preSelectText
				? <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >getEmptyRenderProp(preSelectText)</span>
				: undefined;
&nbsp;
		this.d3LineChart = new DraggableLineChartD3(svg, {
			height: height || <span class="branch-1 cbranch-no" title="branch not covered" >draggableLineChartDefaultProps.height,</span>
			width: width || <span class="branch-1 cbranch-no" title="branch not covered" >draggableLineChartDefaultProps.width,</span>
			margin: margin || <span class="branch-1 cbranch-no" title="branch not covered" >draggableLineChartDefaultProps.margin,</span>
