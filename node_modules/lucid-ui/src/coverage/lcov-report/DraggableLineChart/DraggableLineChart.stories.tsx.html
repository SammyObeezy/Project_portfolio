...
<head>
    <title>Code coverage report for DraggableLineChart/DraggableLineChart.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">DraggableLineChart</a> DraggableLineChart.stories.tsx</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">35.48% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>44/124</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">36.97% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>44/119</span>
            </div>
...
<a name='L674'></a><a href='#L674'>674</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
	return (
		&lt;div style={style}&gt;
			&lt;DraggableLineChart
				{...args}
				onDragEnd={<span class="fstat-no" title="function not covered" >(x</span>, y) =&gt; <span class="cstat-no" title="statement not covered" >console.info({ x, y })}</span>
				data={data}
				width={900}
...
&nbsp;
	const DataInput = <span class="fstat-no" title="function not covered" >({</span>
		xValue,
		yValue,
		myRef,
		changeHandler,
		...
		const onChange = <span class="cstat-no" title="statement not covered" >useCallback(</span>
<span class="fstat-no" title="function not covered" >			(n</span>ewYValue) =&gt; {
<span class="cstat-no" title="statement not covered" >				changeHandler(newYValue, xValue);</span>
			},
...
<span class="fstat-no" title="function not covered" >		on</span>DragHandler(
			newYValue: string,
			xValue: string,
			fromOnChangeHandler?: boolean
		): IData {
			const cleanedYValue = <span class="cstat-no" title="statement not covered" >fromOnChangeHandler</span>
				? newYValue
				: +Number(newYValue).toFixed(0);
			const newCustomSpendDataPoints = <span class="cstat-no" title="statement not covered" >_.map(</span>
				this.state.customSpendDataPoints,
<span class="fstat-no" title="function not covered" >				(d</span>ataPoint) =&gt;
<span class="cstat-no" title="statement not covered" >					dataPoint.x === xValue</span>
						? { ...dataPoint, y: cleanedYValue }
						: dataPoint
			);
<span class="cstat-no" title="statement not covered" >			this.setState({ customSpendDataPoints: newCustomSpendDataPoints });</span>
<span class="cstat-no" title="statement not covered" >			return newCustomSpendDataPoints;</span>
		},
<span class="fstat-no" title="function not covered" >		on</span>ChangeHandler(newYValue: string, xValue: string) {
			const currentIndex = <span class="cstat-no" title="statement not covered" >_.findIndex(this.state.customSpendDataPoints, [</span>
				'x',
				xValue,
			]);
			const currentYValue = <span class="cstat-no" title="statement not covered" >this.state.customSpendDataPoints[currentIndex].y;</span>
			const nextValue = <span class="cstat-no" title="statement not covered" >+Number(newYValue).toFixed(0);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >			if (currentYValue !== nextValue) {</span>
				const newCustomSpendDataPoints = <span class="cstat-no" title="statement not covered" >this.onDragHandler(</span>
					newYValue,
					xValue,
					true
				);
				const nextIndex =
<span class="cstat-no" title="statement not covered" >					currentIndex &gt;= newCustomSpendDataPoints.length - 1</span>
						? 0
						: currentIndex + 1;
&nbsp;
				const myRef = <span class="cstat-no" title="statement not covered" >newCustomSpendDataPoints[nextIndex].ref;</span>
<span class="cstat-no" title="statement not covered" >				setTimeout(<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >myRef.current.focus(),</span> 1);</span>
			}
		},
<span class="fstat-no" title="function not covered" >		ge</span>tRenderProp(
			{
				onChangeHandler,
			}: {
...
<span class="fstat-no" title="function not covered" >		on</span>PreselectHandler(data: ISelectedChartData[]): void {
			const totalSelected = <span class="cstat-no" title="statement not covered" >_.filter(data, ['isSelected', true]).length;</span>
			const avg = <span class="cstat-no" title="statement not covered" >Math.round((100 / totalSelected) * 10) / 10;</span>
			const updatedData = <span class="cstat-no" title="statement not covered" >_.map(data, <span class="fstat-no" title="function not covered" >(s</span>tep) =&gt; (<span class="cstat-no" title="statement not covered" >{</span></span>
				ref: step.ref,
				x: step.x,
				y: step.isSelected ? avg : step.y,
			}));
&nbsp;
<span class="cstat-no" title="statement not covered" >			this.setState({ customSpendDataPoints: updatedData });</span>
		},
<span class="fstat-no" title="function not covered" >		on</span>ChangeHandler(newYValue: string, xValue: string) {
			const currentIndex = <span class="cstat-no" title="statement not covered" >_.findIndex(this.state.customSpendDataPoints, [</span>
				'x',
...
<span class="fstat-no" title="function not covered" >		on</span>PreselectHandler(data: IData): void {
<span class="cstat-no" title="statement not covered" >			this.setState({ customSpendDataPoints: data });</span>
		},
<span class="fstat-no" title="function not covered" >		on</span>ChangeHandler(newYValue: string, xValue: string) {
			const currentIndex = <span class="cstat-no" title="statement not covered" >_.findIndex(this.state.customSpendDataPoints, [</span>
				'x',
			...
			return (
				&lt;div style={style}&gt;
					&lt;DraggableLineChart
						...
						onDragEnd={this.onDragHandler}
						xAxisRenderProp={renderProp}
						yAxisFormatter={<span class="fstat-no" title="function not covered" >(v</span>alue) =&gt; <span class="cstat-no" title="statement not covered" >`${value}%`}</span>
					/&gt;
				&lt;/div&gt;
			);
		},
