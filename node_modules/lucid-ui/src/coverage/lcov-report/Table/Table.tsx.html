    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>137/170</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">60.22% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>53/88</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>132/165</span>
            </div>
...
<a name='L1229'></a><a href='#L1229'>1229</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3308x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3308x</span>
<span class="cline-any cline-yes">3308x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">595x</span>
<span class="cline-any cline-yes">3517x</span>
<span class="cline-any cline-yes">3517x</span>
<span class="cline-any cline-yes">3308x</span>
<span class="cline-any cline-yes">3308x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import _, { omit } from 'lodash';
...
&nbsp;
	getWidth = <span class="fstat-no" title="function not covered" >()</span>: number | null =&gt; {
		const styleWidth = <span class="cstat-no" title="statement not covered" >_.get(this.rootRef, 'style.width');</span>
...
<span class="cstat-no" title="statement not covered" >		if (this.rootRef.current) {</span>
<span class="cstat-no" title="statement not covered" >			return this.rootRef.current.getBoundingClientRect().width;</span>
		}
<span class="cstat-no" title="statement not covered" >		return null;</span>
	};
&nbsp;
	handleClickCapture = <span class="fstat-no" title="function not covered" >(e</span>vent: React.MouseEvent | KeyboardEvent): void =&gt; {
...
&nbsp;
	handleMouseEnter = <span class="fstat-no" title="function not covered" >()</span>: void =&gt; {
<span class="cstat-no" title="statement not covered" >		this.setState({</span>
			isDragging: this.state.isResizing,
		});
	};
&nbsp;
	handleMouseUp = <span class="fstat-no" title="function not covered" >()</span>: void =&gt; {
<span class="cstat-no" title="statement not covered" >		this.setState({</span>
			isDragging: this.state.isResizing,
		});
	};
&nbsp;
	handleDragEnded = <span class="fstat-no" title="function not covered" >(</span>
...
&nbsp;
	handleDragged = <span class="fstat-no" title="function not covered" >(</span>
		coordinates: ICoordinates,
		{
			event,
			props,
		...
		let passiveWidth = <span class="cstat-no" title="statement not covered" >this.state.passiveWidth;</span>
&nbsp;
		const minWidth =
<span class="cstat-no" title="statement not covered" >			this.props.minWidth !== null &amp;&amp; _.isString(this.props.minWidth)</span>
				? parseInt(this.props.minWidth)
				: this.props.minWidth;
<span class="cstat-no" title="statement not covered" >		if (passiveWidth === null) {</span>
<span class="cstat-no" title="statement not covered" >			return;</span>
		} else <span class="cstat-no" title="statement not covered" >if (_.isString(passiveWidth)) {</span>
<span class="cstat-no" title="statement not covered" >			passiveWidth = parseInt(passiveWidth);</span>
		}
&nbsp;
		const activeWidth =
<span class="cstat-no" title="statement not covered" >			(minWidth &amp;&amp; passiveWidth + coordinates.dX &gt; minWidth) || !minWidth</span>
...
&nbsp;
	handleDragStarted = <span class="fstat-no" title="function not covered" >(</span>
		coordinates: ICoordinates,
		{
			event,
			props,
		...
		return (
			&lt;th
				...
				style={
					hasSetWidth
						? _.assign({}, style, {
								width: isResizing ? <span class="branch-0 cbranch-no" title="branch not covered" >activeWidth </span>: passiveWidth,
						  })
						: style
				}
			&gt;
...
function mapToGrid(
	...
	cellType: Th | typeof Td = <span class="branch-0 cbranch-no" title="branch not covered" >Td,</span>
	mapFn: (gridcell: IGridCell, ...args: any[]) =&gt; any = <span class="branch-0 cbranch-no" title="branch not covered" >_.property('element')</span>
) {
...
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if (_.isUndefined(firstRow)) {
<span class="cstat-no" title="statement not covered" >		return [];</span>
	}
&nbsp;
