...
<head>
    <title>Code coverage report for SidePanel/SidePanel.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SidePanel</a> SidePanel.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
/* SidePanel Header **/
const SidePanelHeader = <span class="fstat-no" title="function not covered" >(_</span>props: StandardProps): null =&gt; <span class="cstat-no" title="statement not covered" >null;</span>
...
&nbsp;
	timerId = setTimeout(<span class="fstat-no" title="function not covered" >()</span>: void =&gt; {
<span class="cstat-no" title="statement not covered" >		return;</span>
	}, 1);
&nbsp;
	handleResizeStart = <span class="fstat-no" title="function not covered" >()</span>: void =&gt; {
<span class="cstat-no" title="statement not covered" >		this.setState({</span>
			isResizing: true,
		});
	};
&nbsp;
	handleResize = <span class="fstat-no" title="function not covered" >({</span> dX }: { dX: number }): void =&gt; {
		const { startWidth } = <span class="cstat-no" title="statement not covered" >this.state;</span>
		const position =
<span class="cstat-no" title="statement not covered" >			startWidth + dX * (this.props.position === 'right' ? -1 : 1);</span>
<span class="cstat-no" title="statement not covered" >		this.setState({</span>
			width: _.clamp(
				position,
				this.props.minWidth,
...
&nbsp;
	handleResizeEnd = (
		...
		this.setState({
			width: startWidth + dX * (this.props.position === 'right' ? -1 : <span class="branch-1 cbranch-no" title="branch not covered" >1)</span>,
			isResizing: false,
			startWidth: width,
		});
...
&nbsp;
	componentDidUpdate(prevProps: ISidePanelProps): void {
		<span class="missing-if-branch" title="if path not taken" >I</span>if (prevProps.isExpanded !== this.props.isExpanded) {
<span class="cstat-no" title="statement not covered" >			this.timerId = setTimeout(<span class="fstat-no" title="function not covered" >()</span>: void =&gt; {</span>
<span class="cstat-no" title="statement not covered" >				this.setState({</span>
					isExpanded: this.props.isExpanded as boolean,
				});
			}, 1);
