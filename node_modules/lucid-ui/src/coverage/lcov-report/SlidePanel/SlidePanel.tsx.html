...
<head>
    <title>Code coverage report for SlidePanel/SlidePanel.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">SlidePanel</a> SlidePanel.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
<span class="fstat-no" title="function not covered" >	re</span>nder(): null {
						...
						&lt;div
							...
							style={{
								transform: this.state.isDragging
									? <span class="branch-0 cbranch-no" title="branch not covered" >`translateX(calc(${tween.translateXPercentage}% + ${this.state.translateXPixel}px))`</span>
