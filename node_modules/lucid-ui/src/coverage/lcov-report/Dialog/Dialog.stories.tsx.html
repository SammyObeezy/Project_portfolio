...
<head>
    <title>Code coverage report for Dialog/Dialog.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">Dialog</a> Dialog.stories.tsx</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >			&lt;div style={{ margin: '3em' }}&gt;</span>
				&lt;Story /&gt;
			&lt;/div&gt;
		),
	],
...
&nbsp;
	const handleShow = <span class="fstat-no" title="function not covered" >(i</span>sShown: boolean) =&gt; {
<span class="cstat-no" title="statement not covered" >		setIsShown(isShown);</span>
	};
&nbsp;
	return (
		&lt;div&gt;
...
Basic.decorators = [<span class="fstat-no" title="function not covered" >(S</span>tory) =&gt; <span class="cstat-no" title="statement not covered" >&lt;div style={{ margin: '3em' }}&gt;{Story()}&lt;/div&gt;]</span>;
&nbsp;
export const Small = () =&gt; {
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleShow(isShown: any) {
<span class="cstat-no" title="statement not covered" >			this.setState({ isShown });</span>
		},
&nbsp;
		render() {
			return (
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleSelectedChocolate(isSelected: any) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >		ha</span>ndleSelectedStrawberry(isSelected: any) {
<span class="cstat-no" title="statement not covered" >			this.setState({</span>
				flavors: isSelected
