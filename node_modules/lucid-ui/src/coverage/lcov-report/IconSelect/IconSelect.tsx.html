...
<head>
    <title>Code coverage report for IconSelect/IconSelect.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">IconSelect</a> IconSelect.tsx</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >	if (domNode === document.body) {</span>
<span class="cstat-no" title="statement not covered" >		throw new Error(`domNode is not a child of .${cx('&amp;-Item')}`);</span>
	}
<span class="cstat-no" title="statement not covered" >	if (domNode.parentElement) {</span>
<span class="cstat-no" title="statement not covered" >		return getFigureParent(domNode.parentElement);</span>
	}
&nbsp;
...
<span class="branch-1 cbranch-no" title="branch not covered" >			&lt;Icon&gt;</span>
