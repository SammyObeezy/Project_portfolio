...
<head>
    <title>Code coverage report for IconSelect/IconSelect.stories.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">IconSelect</a> IconSelect.stories.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
	const handleSelect = <span class="fstat-no" title="function not covered" >(i</span>d: string) =&gt; {
		// when selected, set `selectedIcon`
<span class="cstat-no" title="statement not covered" >		setSelectedIcon(id);</span>
	};
&nbsp;
	return (
		&lt;IconSelect
...
&nbsp;
	const handleSelect = <span class="fstat-no" title="function not covered" >(s</span>electedId: string) =&gt; {
<span class="cstat-no" title="statement not covered" >		if (isSelected(selectedId)) {</span>
			// if selected, then remove from list
<span class="cstat-no" title="statement not covered" >			setSelectedIcons(selectedIcons.filter(<span class="fstat-no" title="function not covered" >(i</span>d: any) =&gt; <span class="cstat-no" title="statement not covered" >id !== selectedId)</span>);</span>
		} else {
			// add it to the list
<span class="cstat-no" title="statement not covered" >			setSelectedIcons([...selectedIcons, selectedId]);</span>
		}
	};
&nbsp;
	return (
...
&nbsp;
	const handleSelect = <span class="fstat-no" title="function not covered" >(s</span>electedId: any) =&gt; {
		//const icons = selectedIcons;
&nbsp;
<span class="cstat-no" title="statement not covered" >		if (isPartiallySelected(selectedId)) {</span>
			// if partially selected, remove from the list
<span class="cstat-no" title="statement not covered" >			setSelectedIcons(</span>
				selectedIcons.filter(<span class="fstat-no" title="function not covered" >({</span> id }: any) =&gt; <span class="cstat-no" title="statement not covered" >id !== selectedId)</span>
			);
		} else <span class="cstat-no" title="statement not covered" >if (isSelected(selectedId)) {</span>
			// if already selected, ensure isPartial is true
<span class="cstat-no" title="statement not covered" >			setSelectedIcons(</span>
				selectedIcons.map(<span class="fstat-no" title="function not covered" >({</span> id, isPartial }: any) =&gt; (<span class="cstat-no" title="statement not covered" >{</span>
					id,
...
&nbsp;
	const handleToggleDisabled = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >		setIsDisabled(!isDisabled);</span>
	};
&nbsp;
	return (
		&lt;section&gt;
			&lt;SwitchLabeled
				Label={`IconSelect ${isDisabled ? 'Disabled' : <span class="branch-1 cbranch-no" title="branch not covered" >'Enabled'}</span>`}
