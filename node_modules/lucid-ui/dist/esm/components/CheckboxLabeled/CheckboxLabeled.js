...
export const CheckboxLabeled = (props) => {
    const { className, isIndeterminate, isDisabled, isSelected, onSelect, style, ...passThroughs } = props;
    ...
    return (React.createElement("label", { className: cx('&', {
        ...
        React.createElement(Checkbox, { className: cx('&-Checkbox', className), isDisabled: isDisabled, isIndeterminate: isIndeterminate, isSelected: isSelected, onSelect: onSelect, ..._.omit(passThroughs, nonPassThroughs) }),
        React.createElement("div", { ...labelChildProps, className: cx('&-label', _.get(labelChildProps, 'className', null)) })));
};
...
//# sourceMappingURL=CheckboxLabeled.js.map