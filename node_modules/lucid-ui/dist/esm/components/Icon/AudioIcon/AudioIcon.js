...
export const AudioIcon = ({ className, ...passThroughs }) => {
    return (React.createElement(Icon, { ..._.omit(passThroughs, ['initialState']), className: cx('&', className) },
        React.createElement("path", { d: 'M.5 5.5v5h4l4 4v-13l-4 4zM10.786 11s1.714-.857 1.714-3-1.714-3-1.714-3' }),
        React.createElement("path", { d: 'M12.071 14S15.5 12.286 15.5 8s-3.429-6-3.429-6' })));
};
