...
export declare const DangerLightIcon: {
    ({ className, isClickable, isDisabled, ...passThroughs }: IDangerLightIconProps): JSX.Element;
    displayName: string;
    peek: {
        description: string;
        categories: string[];
...
//# sourceMappingURL=DangerLightIcon.d.ts.map