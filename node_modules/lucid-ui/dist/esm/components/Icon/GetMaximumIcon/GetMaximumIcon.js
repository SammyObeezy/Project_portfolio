...
export const GetMaximumIcon = ({ className, ...passThroughs }) => {
    return (React.createElement(Icon, { ..._.omit(passThroughs, ['initialState']), className: cx('&', className) },
        React.createElement("path", { d: 'M15.5 8.5H.5v-1l15-7z' }),
        React.createElement("path", { d: 'M3.5 13H13M11.5 15l2-2-2-2' }),
        React.createElement("path", { d: 'M12.5 8.5V1.9M9.5 8.5V3.3M6.5 8.5V4.7M3.5 8.5V6.125' })));
};
