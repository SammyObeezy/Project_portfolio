...
export const Icon = (props) => {
    const { className, children, color, size, width, height, viewBox, aspectRatio, isClickable, isDisabled, onClick, onSelect, ...passThroughs } = props;
    ...
    return (React.createElement("svg", { width: width ? width : size, height: height ? height : size, viewBox: viewBox, preserveAspectRatio: aspectRatio, ...passThroughs, className: cx('&', {
            [`&-color-${color}`]: true,
            '&-is-clickable': !isDisabled && isClickable,
            '&-is-disabled': isDisabled,
        }, className), ref: svgRef, onClick: handleClick }, children));
};
