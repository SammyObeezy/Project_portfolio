...
export const ViewTableIcon = ({ className, ...passThroughs }) => {
    return (React.createElement(Icon, { ..._.omit(passThroughs, ['initialState']), className: cx('&', className) },
        React.createElement("path", { d: 'M7.25 13.5h8.25' }),
        React.createElement("path", { d: 'M13.5 15.5l2-2-2-2m2-3v-8H.5v13h4' }),
        React.createElement("path", { d: 'M15.5 4.5H.5' })));
};
