...
export const SaveIcon = ({ className, ...passThroughs }) => {
    return (React.createElement(Icon, { ..._.omit(passThroughs, ['initialState']), className: cx('&', className) },
        React.createElement("path", { d: 'M15.5 15.5H.5V.5h12l3 3z' }),
        React.createElement("circle", { cx: '8', cy: '10', r: '2.25' }),
        React.createElement("path", { d: 'M12 .5v4H4v-4' })));
};
