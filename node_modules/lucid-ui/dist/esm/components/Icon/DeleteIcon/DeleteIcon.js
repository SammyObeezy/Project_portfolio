...
export const DeleteIcon = ({ className, ...passThroughs }) => {
    return (React.createElement(Icon, { ..._.omit(passThroughs, ['initialState']), className: cx('&', className) },
        React.createElement("path", { d: 'M1.5 3h13' }),
        React.createElement("path", { d: 'M2.5 3L3 15.5h10L13.5 3' }),
        React.createElement("path", { d: 'M6 6.503V12.5m4-5.997V12.5' }),
        React.createElement("path", { d: 'M5.5 3l1-2.5h3l1 2.5' })));
};
