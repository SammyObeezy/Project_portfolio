...
export const TextIcon = ({ className, ...passThroughs }) => {
    return (React.createElement(Icon, { ..._.omit(passThroughs, ['initialState']), className: cx('&', className) },
        React.createElement("path", { d: 'M.5 2.5v-2h15v2' }),
        React.createElement("path", { d: 'M8 15.5V.5' }),
        React.createElement("path", { d: 'M4.5 15.5h7' })));
};
