...
export declare const WarningLightIcon: {
    ({ className, isClickable, isDisabled, ...passThroughs }: IWarningLightIconProps): JSX.Element;
    displayName: string;
    peek: {
        description: string;
        categories: string[];
...
//# sourceMappingURL=WarningLightIcon.d.ts.map