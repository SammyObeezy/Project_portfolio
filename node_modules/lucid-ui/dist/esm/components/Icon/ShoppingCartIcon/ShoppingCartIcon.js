...
export const ShoppingCartIcon = ({ className, ...passThroughs }) => {
    return (React.createElement(Icon, { ..._.omit(passThroughs, ['initialState']), className: cx('&', className) },
        React.createElement("path", { d: 'M13.5 14a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zM7 13.5a.5.5 0 1 0 0 1 .5.5 0 0 0 0-1z' }),
        React.createElement("path", { d: 'M14.5 11.5h-9l-2-7h12z' }),
        React.createElement("path", { d: 'M3.5 4.5l-1-2h-2' })));
};
