...
export const EnvelopeIcon = ({ className, ...passThroughs }) => {
    return (React.createElement(Icon, { ..._.omit(passThroughs, ['initialState']), className: cx('&', className) },
        React.createElement("path", { d: 'M.5 2.5h15v11H.5z' }),
        React.createElement("path", { d: 'M.5 3.5l7.5 6 7.5-6m-15 10l6-5m3 0l6 5' })));
};
