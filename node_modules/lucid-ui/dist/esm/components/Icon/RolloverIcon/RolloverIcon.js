...
export const RolloverIcon = ({ className, ...passThroughs }) => {
    return (React.createElement(Icon, { ..._.omit(passThroughs, ['initialState']), className: cx('&', className) },
        React.createElement("path", { d: 'M.5 12.5H6v3H.5zM15.375 12.5h-5.25M10 9.5h5.5v6H10zM12.75 5.955V.5h-9.5v9' }),
        React.createElement("path", { d: 'm10.75 4.5 2 2 2-2' })));
};
