...
export declare const InfoLightIcon: {
    ({ className, isClickable, isDisabled, ...passThroughs }: IInfoLightIconProps): JSX.Element;
    displayName: string;
    peek: {
        description: string;
        categories: string[];
...
//# sourceMappingURL=InfoLightIcon.d.ts.map