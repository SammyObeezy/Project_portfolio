...
export declare type EligibilityOptions = 'left' | 'right' | 'neither' | 'both';
...
export declare const iconPropTypes: {
    ...
    eligibility: PropTypes.Requireable<string>;
...
export declare const EligibilityLightIcon: {
    ({ className, eligibility, isDisabled, ...passThroughs }: IEligibilityLightIconProps): JSX.Element;
    displayName: string;
    propTypes: {
        /** Valid eligibility options for the Icon. */
        eligibility: PropTypes.Requireable<string>;
...
//# sourceMappingURL=EligibilityLightIcon.d.ts.map