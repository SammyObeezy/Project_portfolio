...
export const EligibilityLightIcon = ({ className, eligibility = 'neither', isDisabled = false, ...passThroughs }) => {
    return (React.createElement(Icon
    // As color is fixed for this icon, editing the color prop is disallowed
    , { ..._.omit(passThroughs, ['initialState']), isDisabled: isDisabled, className: cx('&', className) },
        React.createElement("g", null,
            React.createElement("path", { className: cx('&-half-circle', {
...
//# sourceMappingURL=EligibilityLightIcon.js.map