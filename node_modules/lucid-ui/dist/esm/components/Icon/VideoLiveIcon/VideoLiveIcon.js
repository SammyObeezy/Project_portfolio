...
export const VideoLiveIcon = ({ className, ...passThroughs }) => {
    return (React.createElement(Icon, { ..._.omit(passThroughs, ['initialState']), className: cx('&', className) },
        React.createElement("path", { d: 'M2.697 13.303a7.5 7.5 0 010-10.607M13.303 2.697a7.5 7.5 0 010 10.607M11.536 4.465a5 5 0 010 7.071M4.464 11.536a5 5 0 010-7.071M7.188 6.25v3.5L9.812 8z' })));
};
