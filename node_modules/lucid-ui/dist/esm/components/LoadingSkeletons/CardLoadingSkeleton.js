...
export const CardSkeleton = (props) => {
    ...
    return (React.createElement("div", { "data-test-id": 'loadingSkeleton-CardSkeleton', className: cxBackgroundGray('&', className) },
        React.createElement("svg", { "data-test-id": 'loadingSkeleton-CardSkeleton-svg', width: width, height: height, xmlns: 'http://www.w3.org/2000/svg' },
            React.createElement("g", { id: 'CardSkeleton-Details', stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
                React.createElement("g", { id: 'CardSkeleton-Card', className: cxBackgroundGray('&', className), transform: 'translate(-20.000000, -78.000000)' },
                    React.createElement("path", { d: 'M120,95 L120,105 L20,105 L20,95 L120,95 Z M140,78 L140,88 L20,88 L20,78 L140,78 Z', id: 'CardSkeleton-Combined-Shape' }))))));
};
const CardLoadingSkeleton = (props) => {
    return (React.createElement(LoadingSkeleton, { "data-test-id": 'loadingSkeleton-CardLoadingSkeleton', Skeleton: CardSkeleton, ...props }));
};
...
//# sourceMappingURL=CardLoadingSkeleton.js.map