...
export default {
    ...
    parameters: {
        docs: {
            description: {
                component: LineChart.peek.description,
            },
        },
    },
...
export const Basic = (args) => {
    ...
    return (React.createElement("section", { style: style },
        React.createElement(LineChart, { ...args, data: data, width: 800 })));
};
/* Responsive */
export const Responsive = (args) => {
    ...
    return (React.createElement("section", { style: style },
        React.createElement(Resizer, null, (width /*, height */) => (React.createElement(LineChart, { ...args, width: width, height: width * 0.3, data: data })))));
};
/* Multi */
export const Multi = (args) => {
    ...
    return (React.createElement("section", { style: style },
        React.createElement(LineChart, { ...args, data: data, yAxisFields: ['apples', 'oranges', 'pears'], yAxisTitle: 'Fruit Count', width: 800 })));
};
/* Multi With Legend */
export const MultiWithLegend = (args) => {
    const data = [
        {
            x: new Date('2015-01-01T00:00:00-08:00'),
            apples: 2,
    ...
    return (React.createElement("section", { style: style },
        React.createElement(LineChart, { ...args, data: data, yAxisFields: yAxisFields, yAxisTitle: 'Fruit Count', palette: palette, width: 800 }),
        React.createElement(Legend, { style: { verticalAlign: 'top' } }, _.map(yAxisFields, (field, i) => (React.createElement(Legend.Item, { key: field, hasPoint: true, hasLine: true, color: palette[i % palette.length], pointKind: i }, field))))));
};
/* Stacked */
export const Stacked = (args) => {
    ...
    return (React.createElement("section", { style: style },
        React.createElement(LineChart, { ...args, data: data, yAxisFields: [
                'apples',
                'oranges',
                'pears',
                'bananas',
...
export const DualAxis = (args) => {
    ...
    return (React.createElement("section", { style: style },
        React.createElement(LineChart, { ...args, data: data, margin: {
                right: 80,
            }, width: 800, colorMap: {
...
export const AllTheThings = (args) => {
    ...
    return (React.createElement("section", { style: style },
        React.createElement(LineChart, { ...args, margin: {
                right: 80,
...
export const StackedSingleSeriesWithFormatters = (args) => {
    const data = [
    ...
    return (React.createElement("section", { style: style },
        React.createElement(LineChart, { ...args, yAxisIsStacked: true, yAxisFormatter: (yValue) => `$ ${yValue}`, yAxisTooltipFormatter: (yField, yValueFormatted) => yValueFormatted, data: data, width: 800 })));
};
/* Stacked Monochrome No Shapes */
export const StackedMonochromeNoShapes = (args) => {
    const data = [
        {
            x: new Date('2015-01-01T00:00:00-08:00'),
            apples: 2,
    ...
    return (React.createElement("section", { style: style },
        React.createElement(LineChart, { ...args, data: data, width: 800, yAxisFields: ['apples', 'oranges', 'pears', 'bananas', 'kiwis'], yAxisIsStacked: true, yAxisHasPoints: false, yAxisTitle: 'Fruit Count', palette: chartConstants.PALETTE_MONOCHROME_0_5 })));
};
/* Abbreviated Numbers */
export const AbbreviatedNumbers = (args) => {
    const data = [
    ...
    return (React.createElement("section", { style: style },
        React.createElement(LineChart, { ...args, data: data, width: 800, yAxisFields: ['blueberries'], yAxisFormatter: formatters.formatAbbreviatedNumber, yAxisTooltipDataFormatter: formatters.formatThousands })));
};
/* Color Offset */
export const ColorOffset = (args) => {
    const data = [
...
export const Empty = (args) => {
    return (React.createElement(LineChart, { ...args, data: [], yAxisFields: ['blueberries'], width: 800 }));
};
...
/* Empty With Button */
export const EmptyWithButton = (args) => {
    const { EmptyStateWrapper, EmptyStateWrapper: { Title, Body }, } = LineChart;
    return (React.createElement(LineChart, { ...args, data: [], yAxisFields: ['blueberries'], width: 800 },
        React.createElement(EmptyStateWrapper, null,
            React.createElement(Title, null, "Something went wrong."),
...
export const Loading = (args) => {
    return React.createElement(LineChart, { ...args, data: [], width: 800, isLoading: true });
};
/* Fine Grained Ticks */
export const FineGrainedTicks = (args) => {
    const data = [
    ...
    return (React.createElement("section", { style: style },
        React.createElement(LineChart, { ...args, data: data, width: 800, xAxisTicks: _.map(data, 'x'), xAxisFormatter: (date) => date.toLocaleDateString() })));
};
