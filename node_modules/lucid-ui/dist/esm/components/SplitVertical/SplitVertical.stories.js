...
export default {
    ...
    parameters: {
        docs: {
            description: {
                component: SplitVertical.peek.description,
            },
        },
    },
...
export const DefaultSplit = (args) => {
    return (React.createElement(SplitVertical, { ...args },
        React.createElement(SplitVertical.LeftPane, null,
        ...
        React.createElement(SplitVertical.RightPane, null,
...
export const AnimatedCollapse = (args) => {
    ...
    return (React.createElement("section", null,
        ...
        React.createElement(SplitVertical, { ...args, isAnimated: true, isExpanded: isExpanded },
            React.createElement(SplitVertical.LeftPane, null,
...
export const SetPaneAsPrimary = (args) => {
    ...
    return (React.createElement("section", null,
        React.createElement("button", { onClick: handleToggle }, "toggle"),
        React.createElement(SplitVertical, { ...args, isAnimated: true, isExpanded: isExpanded },
            React.createElement(SplitVertical.LeftPane, { isPrimary: true },
...
/* Set Width Of Pane */
export const SetWidthOfPane = (args) => {
    return (React.createElement(SplitVertical, { ...args },
        React.createElement(SplitVertical.LeftPane, { width: 250 },
        ...
        React.createElement(SplitVertical.RightPane, { isPrimary: true },
...
export const CustomizeDivider = (args) => {
    return (React.createElement(SplitVertical, { ...args },
        ...
        React.createElement(SplitVertical.Divider, { style: {
                width: 12,
                background: 'gray',
                color: 'white',
                textAlign: 'center',
...
export const NoAnimation = (args) => {
    ...
    return (React.createElement("section", null,
        React.createElement("button", { onClick: handleToggle }, "toggle"),
        React.createElement(SplitVertical, { ...args, isExpanded: isExpanded },
            React.createElement(SplitVertical.LeftPane, { width: 250 },
...
export const CollapseShift = (args) => {
    ...
    return (React.createElement("section", null,
        React.createElement("button", { onClick: handleToggle }, "toggle"),
        React.createElement(SplitVertical, { ...args, collapseShift: 64, isAnimated: true, isExpanded: isExpanded },
            React.createElement(SplitVertical.LeftPane, { width: 250 },
...
export const HandleResize = (args) => {
    ...
    return (React.createElement("section", null,
        "New Width: ",
        `${newWidth}`,
        React.createElement(SplitVertical, { ...args, onResizing: handleResizing, onResize: handleResize },
            React.createElement(SplitVertical.LeftPane, { width: 250 },
...
/* No Resize */
export const NoResize = (args) => {
    return (React.createElement(SplitVertical, { ...args, isResizeable: false },
        React.createElement(SplitVertical.LeftPane, null,
            React.createElement("p", null, "Occupy biodiesel nesciunt pug fugiat. VHS accusamus intelligentsia, chartreuse raw denim kogi bushwick cold-pressed chia heirloom sint forage. Cornhole affogato swag duis hella, pabst bitters trust fund heirloom viral blog selfies green juice commodo nulla. Single-origin coffee 8-bit ugh jean shorts proident, tote bag small batch meditation poutine next level lo-fi. Ethical before they sold out shoreditch, etsy man braid semiotics ea health goth squid aliquip drinking vinegar kinfolk excepteur polaroid. Meh schlitz cred tattooed chartreuse 3 wolf moon. Lumbersexual poutine kinfolk hella chartreuse thundercats.")),
        React.createElement(SplitVertical.RightPane, null,
            React.createElement("p", null, "Bitters jean shorts trust fund, typewriter assumenda lomo kickstarter waistcoat kombucha officia semiotics fanny pack yr. Ex quinoa nulla franzen, mollit enim kinfolk deep v pop-up consequat. Drinking vinegar beard cillum portland. Beard chambray sartorial est, enim mumblecore craft beer irony paleo pork belly typewriter ugh trust fund blog elit. Nostrud green juice fingerstache, adipisicing art party kitsch gochujang try-hard eu you probably haven't heard of them sed cornhole thundercats iPhone food truck. Scenester poutine tote bag, pug humblebrag 90's ullamco craft beer vice sed actually fanny pack gentrify. Flexitarian kale chips odio minim."))));
};
//# sourceMappingURL=SplitVertical.stories.js.map