...
export interface ILinesProps extends StandardProps, React.SVGProps<SVGGElement> {
    /** Top */
    top?: number;
    /** Left */
    left?: number;
    ...
    xScale: d3Scale.ScaleBand<string> | d3Scale.ScalePoint<string> | d3Scale.ScaleTime<number, number>;
...
export declare const Lines: {
    (props: ILinesProps): React.ReactElement;
    defaultProps: {
        xField: string;
        yFields: string[];
        isStacked: boolean;
