...
export const Lines = (props) => {
    const { className, data, isStacked, palette, colorMap, colorOffset, xScale, xField, yFields, yScale: yScaleOriginal, yStackedMax, ...passThroughs } = props;
    ...
    return (React.createElement("g", { ...passThroughs, className: cx(className, '&') }, _.map(transformedData, (d, dIndex) => (React.createElement("g", { key: dIndex },
        React.createElement(Line, { color: _.get(colorMap, yFields[dIndex], palette[(dIndex + colorOffset) % palette.length]), d: (isStacked ? stackedArea(d) : area(d)), 
