...
export default {
    ...
    parameters: {
        docs: {
            description: {
                component: Autocomplete.peek.description,
            },
        },
    },
};
...
export const Basic = () => {
    const Component = createClass({
        render() {
            return (React.createElement(Autocomplete, { placeholder: 'Enter a word...', suggestions: [
                    'Portland',
                    'pinky and the brain',
                    'playa please',
                    'porridge',
        ...
        render() {
            ...
            return (React.createElement("section", null,
                React.createElement("section", null,
                    "Current Value: ",
                    this.state.value),
                React.createElement(Autocomplete, { placeholder: 'Enter a word...', suggestions: _.size(filteredWordList) <= 1 &&
...
export const Disabled = () => {
    const Component = createClass({
        render() {
            return (React.createElement("section", { style: { minHeight: 100 } },
                React.createElement(Autocomplete, { placeholder: 'Enter a word...', isDisabled: true })));
        },
    });
    return React.createElement(Component, null);
};
...
export const Stateless = () => {
    ...
    const Component = createClass({
        render() {
            return (React.createElement(Autocomplete, { placeholder: 'Enter a word...', suggestions: wordlist, value: 'ab', onSelect: (index) => {
