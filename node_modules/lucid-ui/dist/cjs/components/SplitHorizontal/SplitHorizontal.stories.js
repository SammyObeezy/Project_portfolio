...
exports.HandleResize = exports.CollapseShift = exports.NoAnimation = exports.CustomizeDivider = exports.SetHeightOfPane = exports.SetPaneAsPrimary = exports.AnimatedCollapse = exports.DefaultSplit = void 0;
var react_1 = __importDefault(require("react"));
var create_react_class_1 = __importDefault(require("create-react-class"));
var SplitHorizontal_1 = __importDefault(require("./SplitHorizontal"));
exports.default = {
    title: 'Private/SplitHorizontal',
    component: SplitHorizontal_1.default,
    parameters: {
        docs: {
            description: {
                component: SplitHorizontal_1.default.peek.description,
            },
        },
    },
    args: SplitHorizontal_1.default.defaultProps,
};
/* Default Split */
var DefaultSplit = function (args) {
    return (react_1.default.createElement(SplitHorizontal_1.default, __assign({}, args),
        react_1.default.createElement(SplitHorizontal_1.default.TopPane, null,
        ...
        react_1.default.createElement(SplitHorizontal_1.default.BottomPane, null,
...
exports.DefaultSplit = DefaultSplit;
/* Animated Collapse */
var AnimatedCollapse = function (args) {
    var Component = (0, create_react_class_1.default)({
        ...
        render: function () {
            return (react_1.default.createElement("section", null,
                react_1.default.createElement("button", { onClick: this.handleToggle }, "toggle"),
                react_1.default.createElement("section", { style: { height: 300, outline: '1px solid #e3e3e3' } },
                    react_1.default.createElement(SplitHorizontal_1.default, __assign({}, args, { style: { height: '100%' }, isAnimated: true, isExpanded: this.state.isExpanded }),
                        react_1.default.createElement(SplitHorizontal_1.default.TopPane, null,
                        ...
                        react_1.default.createElement(SplitHorizontal_1.default.BottomPane, null,
                            react_1.default.createElement("p", null, "This pane is primary by default."),
...
/* Set Pane As Primary */
var SetPaneAsPrimary = function (args) {
    var Component = (0, create_react_class_1.default)({
        getInitialState: function () {
            return {
                isExpanded: true,
...
exports.SetPaneAsPrimary = SetPaneAsPrimary;
/* Set Height Of Pane */
var SetHeightOfPane = function (args) {
    return (react_1.default.createElement("section", { style: { height: 300, outline: '1px solid #e3e3e3' } },
        react_1.default.createElement(SplitHorizontal_1.default, __assign({}, args),
            react_1.default.createElement(SplitHorizontal_1.default.TopPane, { height: 64 },
...
var CustomizeDivider = function (args) {
    return (react_1.default.createElement(SplitHorizontal_1.default, __assign({}, args),
        ...
        react_1.default.createElement(SplitHorizontal_1.default.Divider, { style: {
                height: 18,
                background: 'gray',
                color: 'white',
                textAlign: 'center',
...
var NoAnimation = function (args) {
    var Component = (0, create_react_class_1.default)({
        ...
        render: function () {
            return (react_1.default.createElement("section", null,
                react_1.default.createElement("button", { onClick: this.handleToggle }, "toggle"),
                react_1.default.createElement("section", { style: { outline: '1px solid #e3e3e3' } },
                    react_1.default.createElement(SplitHorizontal_1.default, __assign({}, args, { isExpanded: this.state.isExpanded }),
                        react_1.default.createElement(SplitHorizontal_1.default.TopPane, null,
...
/* Collapse Shift */
var CollapseShift = function (args) {
    var Component = (0, create_react_class_1.default)({
        getInitialState: function () {
            return {
                isExpanded: true,
        ...
        render: function () {
            return (react_1.default.createElement("section", null,
                react_1.default.createElement("button", { onClick: this.handleToggle }, "toggle"),
                react_1.default.createElement("section", { style: { height: 300, outline: '1px solid #e3e3e3' } },
                    react_1.default.createElement(SplitHorizontal_1.default, __assign({}, args, { style: { height: '100%' }, collapseShift: 64, isAnimated: true, isExpanded: this.state.isExpanded }),
                        react_1.default.createElement(SplitHorizontal_1.default.TopPane, null,
                            react_1.default.createElement("p", null, "This pane will stick out by 64px when collapsed."),
                        ...
                        react_1.default.createElement(SplitHorizontal_1.default.BottomPane, { isPrimary: true },
                            react_1.default.createElement("p", null, "This is the primary pane."),
...
exports.CollapseShift = CollapseShift;
/* Handle Resize */
var HandleResize = function (args) {
    var Component = (0, create_react_class_1.default)({
        getInitialState: function () {
            return {
                newHeight: null,
        ...
        handleResizing: function (height) {
        ...
        render: function () {
            return (react_1.default.createElement("section", null,
                "New Height: ", "".concat(this.state.newHeight),
                react_1.default.createElement("section", { style: { height: 300, outline: '1px solid #e3e3e3' } },
                    react_1.default.createElement(SplitHorizontal_1.default, __assign({}, args, { style: { height: '100%' }, onResizing: this.handleResizing, onResize: this.handleResize }),
                        react_1.default.createElement(SplitHorizontal_1.default.TopPane, { height: 250 },
...
//# sourceMappingURL=SplitHorizontal.stories.js.map