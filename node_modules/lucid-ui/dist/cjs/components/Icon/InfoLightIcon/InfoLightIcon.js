...
exports.InfoLightIcon = void 0;
var lodash_1 = require("lodash");
var react_1 = __importDefault(require("react"));
var prop_types_1 = __importDefault(require("prop-types"));
var Icon_1 = __importDefault(require("../Icon"));
var style_helpers_1 = require("../../../util/style-helpers");
var cx = style_helpers_1.lucidClassNames.bind('&-InfoLightIcon');
var iconPropTypes = {
...
var InfoLightIcon = function (_a) {
    ...
    return (react_1.default.createElement(Icon_1.default, __assign({}, (0, lodash_1.omit)(passThroughs, ['initialState']), { isClickable: isClickable, isDisabled: isDisabled, className: cx('&', isDisabled && '&-is-disabled', isClickable && '&-is-clickable', className) }),
        ...
        react_1.default.createElement("path", { className: cx('&-stem'), d: 'M7.99 12.5v-6' }),
        react_1.default.createElement("circle", { className: cx('&-dot'), cx: '7.99', cy: '4', r: '.293' })));
};
exports.InfoLightIcon = InfoLightIcon;
exports.InfoLightIcon.displayName = 'InfoLightIcon';
exports.InfoLightIcon.peek = {
    description: "\n\t\tDEPRECATED: this component should not be used and will be removed from the library in a future release.\n\t\t\n\t\tA light info icon.\n\t",
    categories: ['visual design', 'icons'],
    extend: 'Icon',
    madeFrom: ['Icon'],
};
exports.InfoLightIcon.propTypes = iconPropTypes;
exports.InfoLightIcon.defaultProps = Icon_1.default.defaultProps;
exports.default = exports.InfoLightIcon;
//# sourceMappingURL=InfoLightIcon.js.map